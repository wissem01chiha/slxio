...
namespace slxio {
std::string SimulinkParameterString::GetName()
{
  return std::string();
}
...
std::string SimulinkParameterString::ToString() const
{
  return std::string();
}
...
Float32 SimulinkParameterString::GetMin()
{
  return Float64();
}

Float32 slxio::SimulinkParameterString::GetMax()
{
  return Float64();
}
