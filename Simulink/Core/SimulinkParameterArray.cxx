...
std::string slxio::SimulinkParameterArray::GetName() { return Name; }

std::vector<UInt16> SimulinkParameterArray::GetDimensions() {
  return Dimensions;
}

std::string SimulinkParameterArray::ToString() const { return std::string(); }
...
Float32 SimulinkParameterArray::GetMin() { return Float32(); }

Float32 SimulinkParameterArray::GetMax() { return Float32(); }

SimulinkDataType SimulinkParameterArray::GetDataType() { return DataType; }
