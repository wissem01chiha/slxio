...
#ifndef CHECKDISCRETEGRADIENT_H
#define CHECKDISCRETEGRADIENT_H
...
class SLXIO_APIEXPORT CheckDiscreteGradient : public IBlockParameters, public IBlockProperties
{
public:
  /** Default Constructor */
  ...
  const std::string& GetGradient() const;
  void SetGradient(const std::string& value);
