...
#ifndef CHECKDYNAMICLOWERBOUND_H
#define CHECKDYNAMICLOWERBOUND_H
...
class SLXIO_APIEXPORT CheckDynamicLowerBound : public IBlockParameters, public IBlockProperties
{
public:
  /** Default Constructor */
...
#endif // CHECKDYNAMICLOWERBOUND_H
