...
#ifndef CHECKSTATICGAP_H
#define CHECKSTATICGAP_H
...
class SLXIO_APIEXPORT CheckStaticGap : public IBlockParameters, public IBlockProperties
{
public:
  /** Default Constructor */
  CheckStaticGap();
