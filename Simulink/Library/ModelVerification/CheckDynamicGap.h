...
#ifndef CHECKDYNAMICGAP_H
#define CHECKDYNAMICGAP_H
...
class SLXIO_APIEXPORT CheckDynamicGap : public IBlockParameters, public IBlockProperties
{
public:
  /** Default Constructor */
  CheckDynamicGap();
