...
const std::string& CheckDynamicRange::GetEnabled() const
{
  return m_Enabled;
}
...
const std::string& CheckDynamicRange::GetCallback() const
{
  return m_Callback;
}
...
const std::string& CheckDynamicRange::GetExport() const
{
  return m_Export;
}
...
const std::string& CheckDynamicRange::GetIcon() const
{
  return m_Icon;
}

void CheckDynamicRange::SetIcon(const std::string& value)
{
  m_Icon = value;
}
