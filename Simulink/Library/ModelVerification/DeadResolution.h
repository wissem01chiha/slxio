...
#ifndef DEADRESOLUTION_H
#define DEADRESOLUTION_H
...
class SLXIO_APIEXPORT DeadResolution : public IBlockParameters, public IBlockProperties
{
public:
  /** Default Constructor */
  DeadResolution();
