...
const std::string& Assertion::GetEnabled() const { return m_Enabled; }

void Assertion::SetEnabled(const std::string& value) { m_Enabled = value; }
...
const std::string& Assertion::GetSampletime() const { return m_Sampletime; }
