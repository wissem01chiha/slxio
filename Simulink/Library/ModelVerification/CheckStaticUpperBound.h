...
#ifndef CHECKSTATICUPPERBOUND_H
#define CHECKSTATICUPPERBOUND_H
...
class SLXIO_APIEXPORT CheckStaticUpperBound : public IBlockParameters, public IBlockProperties
{
public:
  /** Default Constructor */
