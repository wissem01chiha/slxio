...
#ifndef CHECKSTATICLOWERBOUND_H
#define CHECKSTATICLOWERBOUND_H
...
class SLXIO_APIEXPORT CheckStaticLowerBound : public IBlockParameters, public IBlockProperties
{
public:
  /** Default Constructor */
