...
#ifndef DATATYPECONVERSION1_H
#define DATATYPECONVERSION1_H
...
class SLXIO_APIEXPORT DataTypeConversion1 : public IBlockParameters, public IBlockProperties
{
public:
  /** Default Constructor */
  DataTypeConversion1();
