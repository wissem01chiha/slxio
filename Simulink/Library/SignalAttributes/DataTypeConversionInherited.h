...
#ifndef DATATYPECONVERSIONINHERITED_H
#define DATATYPECONVERSIONINHERITED_H
...
class SLXIO_APIEXPORT DataTypeConversionInherited : public IBlockParameters, public IBlockProperties
{
public:
  /** Default Constructor */
...
#endif // DATATYPECONVERSIONINHERITED_H
