...
#ifndef FIXPTGATEWAYOUT_H
#define FIXPTGATEWAYOUT_H
...
class SLXIO_APIEXPORT FixptGatewayOut : public IBlockParameters, public IBlockProperties
{
public:
  /** Default Constructor */
  FixptGatewayOut();
