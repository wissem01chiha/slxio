...
const std::string& Enable::GetZerocross() const { return m_Zerocross; }

void Enable::SetZerocross(const std::string& value) { m_Zerocross = value; }
...
const std::string& Enable::GetSampletime() const { return m_Sampletime; }

void Enable::SetSampletime(const std::string& value) { m_Sampletime = value; }

const std::string& Enable::GetOutmin() const { return m_Outmin; }

void Enable::SetOutmin(const std::string& value) { m_Outmin = value; }

const std::string& Enable::GetOutmax() const { return m_Outmax; }

void Enable::SetOutmax(const std::string& value) { m_Outmax = value; }
...
const std::string& Enable::GetInterpolate() const { return m_Interpolate; }

void Enable::SetInterpolate(const std::string& value) { m_Interpolate = value; }
