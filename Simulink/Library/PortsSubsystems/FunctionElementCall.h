...
#ifndef FUNCTIONELEMENTCALL_H
#define FUNCTIONELEMENTCALL_H
...
class SLXIO_APIEXPORT FunctionElementCall : public IBlockParameters, public IBlockProperties
{
public:
  /** Default Constructor */
  FunctionElementCall();
  ...
  const std::string& GetIsbuselementport() const;
  void SetIsbuselementport(const std::string& value);
