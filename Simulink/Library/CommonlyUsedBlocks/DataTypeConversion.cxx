...
const std::string& DataTypeConversion::GetOutmin() const
{
    return m_Outmin;
}
...
const std::string& DataTypeConversion::GetOutmax() const
{
    return m_Outmax;
}
...
const std::string& DataTypeConversion::GetRndmeth() const
{
    return m_Rndmeth;
}
