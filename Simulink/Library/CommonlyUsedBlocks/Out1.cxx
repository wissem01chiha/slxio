...
const std::string& Out1::GetPort() const
{
    return m_Port;
}

void Out1::SetPort(const std::string& value)
{
    m_Port = value;
}

const std::string& Out1::GetSignalname() const
{
    return m_Signalname;
}

void Out1::SetSignalname(const std::string& value)
{
    m_Signalname = value;
}

const std::string& Out1::GetSignalobject() const
{
    return m_Signalobject;
}

void Out1::SetSignalobject(const std::string& value)
{
    m_Signalobject = value;
}

const std::string& Out1::GetStorageclass() const
{
    return m_Storageclass;
}

void Out1::SetStorageclass(const std::string& value)
{
    m_Storageclass = value;
}

const std::string& Out1::GetIcondisplay() const
{
    return m_Icondisplay;
}

void Out1::SetIcondisplay(const std::string& value)
{
    m_Icondisplay = value;
}
...
const std::string& Out1::GetOutmin() const
{
    return m_Outmin;
}

void Out1::SetOutmin(const std::string& value)
{
    m_Outmin = value;
}

const std::string& Out1::GetOutmax() const
{
    return m_Outmax;
}

void Out1::SetOutmax(const std::string& value)
{
    m_Outmax = value;
}

const std::string& Out1::GetOutdatatypestr() const
{
...
const std::string& Out1::GetLockscale() const
{
    return m_Lockscale;
}

void Out1::SetLockscale(const std::string& value)
{
    m_Lockscale = value;
}
...
const std::string& Out1::GetBusvirtuality() const
{
...
const std::string& Out1::GetDatamode() const
{
    return m_Datamode;
}

void Out1::SetDatamode(const std::string& value)
{
    m_Datamode = value;
}

const std::string& Out1::GetUnit() const
{
    return m_Unit;
}

void Out1::SetUnit(const std::string& value)
{
    m_Unit = value;
}

const std::string& Out1::GetPortdimensions() const
{
...
const std::string& Out1::GetVarsizesig() const
{
    return m_Varsizesig;
}

void Out1::SetVarsizesig(const std::string& value)
{
    m_Varsizesig = value;
}

const std::string& Out1::GetSampletime() const
{
    return m_Sampletime;
}

void Out1::SetSampletime(const std::string& value)
{
    m_Sampletime = value;
}

const std::string& Out1::GetSignaltype() const
{
    return m_Signaltype;
}

void Out1::SetSignaltype(const std::string& value)
{
    m_Signaltype = value;
}
...
const std::string& Out1::GetInitialoutput() const
{
