...
#ifndef MULTIPORTSWITCH_H
#define MULTIPORTSWITCH_H
...
class SLXIO_APIEXPORT Multiportswitch : public IBlockParameters, public IBlockProperties
{
public:
  /** Default Constructor */
  Multiportswitch();
