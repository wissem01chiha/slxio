...
const std::string& WaveformGenerator::GetOutmin() const
{
  return m_Outmin;
}
...
const std::string& WaveformGenerator::GetOutmax() const
{
  return m_Outmax;
}
...
const std::string& WaveformGenerator::GetRndmeth() const
{
  return m_Rndmeth;
}
