...
const std::string& SignalGenerator::GetWaveform() const
{
  return m_Waveform;
}
...
const std::string& SignalGenerator::GetAmplitude() const
{
  return m_Amplitude;
}
...
const std::string& SignalGenerator::GetFrequency() const
{
  return m_Frequency;
}
...
const std::string& SignalGenerator::GetUnits() const
{
  return m_Units;
}

void SignalGenerator::SetUnits(const std::string& value)
{
  m_Units = value;
}
