...
#ifndef FORCETOBESCALAR_H
#define FORCETOBESCALAR_H
...
class SLXIO_APIEXPORT ForceToBeScalar : public IBlockParameters, public IBlockProperties
{
public:
  /** Default Constructor */
  ForceToBeScalar();
