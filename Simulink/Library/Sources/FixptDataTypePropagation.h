...
#ifndef FIXPTDATATYPEPROPAGATION_H
#define FIXPTDATATYPEPROPAGATION_H
...
class SLXIO_APIEXPORT FixptDataTypePropagation : public IBlockParameters, public IBlockProperties
{
public:
  /** Default Constructor */
  FixptDataTypePropagation();
...
#endif // FIXPTDATATYPEPROPAGATION_H
