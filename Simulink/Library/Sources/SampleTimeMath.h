...
#ifndef SAMPLETIMEMATH_H
#define SAMPLETIMEMATH_H
...
class SLXIO_APIEXPORT SampleTimeMath : public IBlockParameters, public IBlockProperties
{
public:
  /** Default Constructor */
  SampleTimeMath();
