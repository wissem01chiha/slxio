...
const std::string& UniformRandomNumber::GetMinimum() const
{
    return m_Minimum;
}
...
const std::string& UniformRandomNumber::GetMaximum() const
{
    return m_Maximum;
}
...
const std::string& UniformRandomNumber::GetSeed() const
{
    return m_Seed;
}

void UniformRandomNumber::SetSeed(const std::string& value)
{
    m_Seed = value;
}
