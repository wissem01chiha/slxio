...
const std::string& FromFile::GetFilename() const
{
    return m_Filename;
}

void FromFile::SetFilename(const std::string& value)
{
    m_Filename = value;
}
...
const std::string& FromFile::GetSampletime() const
{
    return m_Sampletime;
}

void FromFile::SetSampletime(const std::string& value)
{
    m_Sampletime = value;
}
...
const std::string& FromFile::GetZerocross() const
{
    return m_Zerocross;
}

void FromFile::SetZerocross(const std::string& value)
{
    m_Zerocross = value;
}
