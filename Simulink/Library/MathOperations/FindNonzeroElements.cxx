...
const std::string& FindNonzeroElements::GetShowoutputfornonzeroinputvalues() const
{
    return m_Showoutputfornonzeroinputvalues;
}

void FindNonzeroElements::SetShowoutputfornonzeroinputvalues(const std::string& value)
{
