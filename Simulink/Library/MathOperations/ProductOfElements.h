...
#ifndef PRODUCTOFELEMENTS_H
#define PRODUCTOFELEMENTS_H
...
class SLXIO_APIEXPORT ProductOfElements : public IBlockParameters, public IBlockProperties
{
public:
  /** Default Constructor */
  ProductOfElements();
