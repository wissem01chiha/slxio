...
#ifndef WEIGHTEDSAMPLETIMEMATH_H
#define WEIGHTEDSAMPLETIMEMATH_H
...
class SLXIO_APIEXPORT WeightedSampleTimeMath : public IBlockParameters, public IBlockProperties
{
public:
  /** Default Constructor */
...
#endif // WEIGHTEDSAMPLETIMEMATH_H
