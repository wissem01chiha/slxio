...
const std::string& SineWaveFunction::GetSinetype() const
{
  return m_Sinetype;
}
...
const std::string& SineWaveFunction::GetBias() const
{
  return m_Bias;
}

void SineWaveFunction::SetBias(const std::string& value)
{
  m_Bias = value;
}
...
const std::string& SineWaveFunction::GetPhase() const
{
  return m_Phase;
}

void SineWaveFunction::SetPhase(const std::string& value)
{
  m_Phase = value;
}

const std::string& SineWaveFunction::GetSamples() const
{
  return m_Samples;
}
...
const std::string& SineWaveFunction::GetOffset() const
{
  return m_Offset;
}

void SineWaveFunction::SetOffset(const std::string& value)
{
  m_Offset = value;
}
