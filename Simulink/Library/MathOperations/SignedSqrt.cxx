...
const std::string& SignedSqrt::GetOperator() const { return m_Operator; }

void SignedSqrt::SetOperator(const std::string& value) { m_Operator = value; }
...
const std::string& SignedSqrt::GetSampletime() const { return m_Sampletime; }
...
const std::string& SignedSqrt::GetOutmin() const { return m_Outmin; }

void SignedSqrt::SetOutmin(const std::string& value) { m_Outmin = value; }

const std::string& SignedSqrt::GetOutmax() const { return m_Outmax; }

void SignedSqrt::SetOutmax(const std::string& value) { m_Outmax = value; }
...
const std::string& SignedSqrt::GetLockscale() const { return m_Lockscale; }

void SignedSqrt::SetLockscale(const std::string& value) { m_Lockscale = value; }

const std::string& SignedSqrt::GetRndmeth() const { return m_Rndmeth; }

void SignedSqrt::SetRndmeth(const std::string& value) { m_Rndmeth = value; }
...
const std::string& SignedSqrt::GetIterations() const { return m_Iterations; }
