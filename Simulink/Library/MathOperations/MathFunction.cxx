...
const std::string& MathFunction::GetOperator() const
{
  return m_Operator;
}

void MathFunction::SetOperator(const std::string& value)
{
  m_Operator = value;
}
...
const std::string& MathFunction::GetSampletime() const
{
  return m_Sampletime;
}
...
const std::string& MathFunction::GetOutmin() const
{
  return m_Outmin;
}

void MathFunction::SetOutmin(const std::string& value)
{
  m_Outmin = value;
}

const std::string& MathFunction::GetOutmax() const
{
  return m_Outmax;
}

void MathFunction::SetOutmax(const std::string& value)
{
  m_Outmax = value;
}
...
const std::string& MathFunction::GetLockscale() const
{
  return m_Lockscale;
}
...
const std::string& MathFunction::GetRndmeth() const
{
  return m_Rndmeth;
}

void MathFunction::SetRndmeth(const std::string& value)
{
  m_Rndmeth = value;
}
...
const std::string& MathFunction::GetIterations() const
{
  return m_Iterations;
}
