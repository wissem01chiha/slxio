...
#ifndef RECIPROCALSQRT_H
#define RECIPROCALSQRT_H
...
class SLXIO_APIEXPORT ReciprocalSqrt : public IBlockParameters, public IBlockProperties
{
public:
  /** Default Constructor */
  ReciprocalSqrt();
