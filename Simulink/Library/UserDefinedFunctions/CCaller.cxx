...
const std::string& CCaller::GetFunctionname() const { return m_Functionname; }
...
const std::string& CCaller::GetSampletime() const { return m_Sampletime; }

void CCaller::SetSampletime(const std::string& value) { m_Sampletime = value; }
