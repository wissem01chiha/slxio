...
const std::string& MatrixMultiply::GetInputs() const
{
    return m_Inputs;
}

void MatrixMultiply::SetInputs(const std::string& value)
{
    m_Inputs = value;
}
...
const std::string& MatrixMultiply::GetOutmin() const
{
    return m_Outmin;
}

void MatrixMultiply::SetOutmin(const std::string& value)
{
    m_Outmin = value;
}

const std::string& MatrixMultiply::GetOutmax() const
{
    return m_Outmax;
}

void MatrixMultiply::SetOutmax(const std::string& value)
{
    m_Outmax = value;
}
...
const std::string& MatrixMultiply::GetLockscale() const
{
    return m_Lockscale;
}
...
const std::string& MatrixMultiply::GetRndmeth() const
{
    return m_Rndmeth;
}

void MatrixMultiply::SetRndmeth(const std::string& value)
{
    m_Rndmeth = value;
}
