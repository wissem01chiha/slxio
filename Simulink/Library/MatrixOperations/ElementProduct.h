...
#ifndef ELEMENTPRODUCT_H
#define ELEMENTPRODUCT_H
...
class SLXIO_APIEXPORT ElementProduct : public IBlockParameters, public IBlockProperties
{
public:
  /** Default Constructor */
  ElementProduct();
