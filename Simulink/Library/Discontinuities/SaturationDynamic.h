...
#ifndef SATURATIONDYNAMIC_H
#define SATURATIONDYNAMIC_H
...
class SLXIO_APIEXPORT SaturationDynamic : public IBlockParameters, public IBlockProperties
{
public:
  /** Default Constructor */
  SaturationDynamic();
