...
#ifndef DELTAFALLLIMIT_H
#define DELTAFALLLIMIT_H
...
class SLXIO_APIEXPORT DeltaFallLimit : public IBlockParameters, public IBlockProperties
{
public:
  /** Default Constructor */
  DeltaFallLimit();
