...
#ifndef DIFFERENCEINPUTS1_H
#define DIFFERENCEINPUTS1_H
...
class SLXIO_APIEXPORT DifferenceInputs1 : public IBlockParameters, public IBlockProperties
{
public:
  /** Default Constructor */
  DifferenceInputs1();
