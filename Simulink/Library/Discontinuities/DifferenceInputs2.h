...
#ifndef DIFFERENCEINPUTS2_H
#define DIFFERENCEINPUTS2_H
...
class SLXIO_APIEXPORT DifferenceInputs2 : public IBlockParameters, public IBlockProperties
{
public:
  /** Default Constructor */
  DifferenceInputs2();
