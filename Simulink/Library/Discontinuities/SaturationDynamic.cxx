...
const std::string& SaturationDynamic::GetOutmin() const { return m_Outmin; }
...
const std::string& SaturationDynamic::GetOutmax() const { return m_Outmax; }
...
const std::string& SaturationDynamic::GetRndmeth() const { return m_Rndmeth; }
...
const std::string& SaturationDynamic::GetDosatur() const { return m_Dosatur; }
