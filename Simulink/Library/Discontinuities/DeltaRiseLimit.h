...
#ifndef DELTARISELIMIT_H
#define DELTARISELIMIT_H
...
class SLXIO_APIEXPORT DeltaRiseLimit : public IBlockParameters, public IBlockProperties
{
public:
  /** Default Constructor */
  DeltaRiseLimit();
