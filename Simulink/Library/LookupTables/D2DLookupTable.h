...
#ifndef D2DLOOKUPTABLE_H
#define D2DLOOKUPTABLE_H
...
class SLXIO_APIEXPORT D2DLookupTable : public IBlockParameters, public IBlockProperties
{
public:
  /** Default Constructor */
  D2DLookupTable();
