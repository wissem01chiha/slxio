...
#ifndef OUTPUTFROMLOOKUPTABLE_H
#define OUTPUTFROMLOOKUPTABLE_H
...
class SLXIO_APIEXPORT OutputFromLookupTable : public IBlockParameters, public IBlockProperties
{
public:
  /** Default Constructor */
  OutputFromLookupTable();
