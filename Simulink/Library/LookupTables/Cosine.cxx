...
const std::string& Cosine::GetFormula() const { return m_Formula; }

void Cosine::SetFormula(const std::string& value) { m_Formula = value; }

const std::string& Cosine::GetNumdatapoints() const { return m_Numdatapoints; }
