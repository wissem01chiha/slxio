...
#ifndef EMPTYSUBSYSTEM_H
#define EMPTYSUBSYSTEM_H
...
class SLXIO_APIEXPORT Emptysubsystem : public IBlockParameters, public IBlockProperties
{
public:
  /** Default Constructor */
  Emptysubsystem();
