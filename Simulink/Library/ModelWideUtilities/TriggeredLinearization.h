...
#ifndef TRIGGEREDLINEARIZATION_H
#define TRIGGEREDLINEARIZATION_H
...
class SLXIO_APIEXPORT TriggeredLinearization : public IBlockParameters, public IBlockProperties
{
public:
  /** Default Constructor */
  TriggeredLinearization();
...
#endif // TRIGGEREDLINEARIZATION_H
