...
const std::string& BitwiseOr::GetLogicop() const { return m_Logicop; }

void BitwiseOr::SetLogicop(const std::string& value) { m_Logicop = value; }

const std::string& BitwiseOr::GetUsebitmask() const { return m_Usebitmask; }
...
const std::string& BitwiseOr::GetBitmask() const { return m_Bitmask; }

void BitwiseOr::SetBitmask(const std::string& value) { m_Bitmask = value; }
