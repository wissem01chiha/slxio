...
#ifndef GREATERTHANOREQUAL_H
#define GREATERTHANOREQUAL_H
...
class SLXIO_APIEXPORT Greaterthanorequal : public IBlockParameters, public IBlockProperties
{
public:
  /** Default Constructor */
  Greaterthanorequal();
