...
#ifndef INPUTTOLOOKUPTABLE_H
#define INPUTTOLOOKUPTABLE_H
...
class SLXIO_APIEXPORT InputToLookupTable : public IBlockParameters, public IBlockProperties
{
public:
  /** Default Constructor */
  InputToLookupTable();
