...
#ifndef SIGNEDSQUAREROOT_H
#define SIGNEDSQUAREROOT_H
...
class SLXIO_APIEXPORT SignedSquareRoot : public IBlockParameters, public IBlockProperties
{
public:
  /** Default Constructor */
  SignedSquareRoot();
