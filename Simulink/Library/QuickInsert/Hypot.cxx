...
const std::string& Hypot::GetOperator() const
{
    return m_Operator;
}

void Hypot::SetOperator(const std::string& value)
{
    m_Operator = value;
}
...
const std::string& Hypot::GetSignedpower() const
{
    return m_Signedpower;
}

void Hypot::SetSignedpower(const std::string& value)
{
    m_Signedpower = value;
}
...
const std::string& Hypot::GetSampletime() const
{
    return m_Sampletime;
}

void Hypot::SetSampletime(const std::string& value)
{
    m_Sampletime = value;
}

const std::string& Hypot::GetOutmin() const
{
    return m_Outmin;
}

void Hypot::SetOutmin(const std::string& value)
{
    m_Outmin = value;
}

const std::string& Hypot::GetOutmax() const
{
    return m_Outmax;
}

void Hypot::SetOutmax(const std::string& value)
{
    m_Outmax = value;
}

const std::string& Hypot::GetOutdatatypestr() const
{
...
const std::string& Hypot::GetLockscale() const
{
    return m_Lockscale;
}

void Hypot::SetLockscale(const std::string& value)
{
    m_Lockscale = value;
}

const std::string& Hypot::GetRndmeth() const
{
    return m_Rndmeth;
}

void Hypot::SetRndmeth(const std::string& value)
{
    m_Rndmeth = value;
}
...
const std::string& Hypot::GetAlgorithmtype() const
{
...
const std::string& Hypot::GetIterations() const
{
    return m_Iterations;
}

void Hypot::SetIterations(const std::string& value)
{
    m_Iterations = value;
}
