...
const std::string& Output::GetPort() const
{
    return m_Port;
}

void Output::SetPort(const std::string& value)
{
    m_Port = value;
}

const std::string& Output::GetSignalname() const
{
    return m_Signalname;
}

void Output::SetSignalname(const std::string& value)
{
    m_Signalname = value;
}

const std::string& Output::GetSignalobject() const
{
...
const std::string& Output::GetStorageclass() const
{
...
const std::string& Output::GetIcondisplay() const
{
    return m_Icondisplay;
}

void Output::SetIcondisplay(const std::string& value)
{
    m_Icondisplay = value;
}
...
const std::string& Output::GetBusvirtuality() const
{
...
const std::string& Output::GetDatamode() const
{
    return m_Datamode;
}

void Output::SetDatamode(const std::string& value)
{
    m_Datamode = value;
}

const std::string& Output::GetUnit() const
{
    return m_Unit;
}

void Output::SetUnit(const std::string& value)
{
    m_Unit = value;
}
...
const std::string& Output::GetVarsizesig() const
{
    return m_Varsizesig;
}

void Output::SetVarsizesig(const std::string& value)
{
    m_Varsizesig = value;
}
...
const std::string& Output::GetSignaltype() const
{
    return m_Signaltype;
}

void Output::SetSignaltype(const std::string& value)
{
    m_Signaltype = value;
}
...
const std::string& Output::GetInitialoutput() const
{
