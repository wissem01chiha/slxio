...
const std::string& CastToSingle::GetOutmin() const { return m_Outmin; }

void CastToSingle::SetOutmin(const std::string& value) { m_Outmin = value; }

const std::string& CastToSingle::GetOutmax() const { return m_Outmax; }

void CastToSingle::SetOutmax(const std::string& value) { m_Outmax = value; }
...
const std::string& CastToSingle::GetLockscale() const { return m_Lockscale; }
...
const std::string& CastToSingle::GetRndmeth() const { return m_Rndmeth; }

void CastToSingle::SetRndmeth(const std::string& value) { m_Rndmeth = value; }
...
const std::string& CastToSingle::GetSampletime() const { return m_Sampletime; }
