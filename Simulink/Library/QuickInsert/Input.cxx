...
const std::string& Input::GetPort() const
{
    return m_Port;
}

void Input::SetPort(const std::string& value)
{
    m_Port = value;
}

const std::string& Input::GetIcondisplay() const
{
    return m_Icondisplay;
}

void Input::SetIcondisplay(const std::string& value)
{
    m_Icondisplay = value;
}
...
const std::string& Input::GetOutmin() const
{
    return m_Outmin;
}

void Input::SetOutmin(const std::string& value)
{
    m_Outmin = value;
}

const std::string& Input::GetOutmax() const
{
    return m_Outmax;
}

void Input::SetOutmax(const std::string& value)
{
    m_Outmax = value;
}

const std::string& Input::GetOutdatatypestr() const
{
...
const std::string& Input::GetLockscale() const
{
    return m_Lockscale;
}

void Input::SetLockscale(const std::string& value)
{
    m_Lockscale = value;
}
...
const std::string& Input::GetBusvirtuality() const
{
...
const std::string& Input::GetUnit() const
{
    return m_Unit;
}

void Input::SetUnit(const std::string& value)
{
    m_Unit = value;
}

const std::string& Input::GetPortdimensions() const
{
...
const std::string& Input::GetVarsizesig() const
{
    return m_Varsizesig;
}

void Input::SetVarsizesig(const std::string& value)
{
    m_Varsizesig = value;
}

const std::string& Input::GetSampletime() const
{
    return m_Sampletime;
}

void Input::SetSampletime(const std::string& value)
{
    m_Sampletime = value;
}

const std::string& Input::GetSignaltype() const
{
    return m_Signaltype;
}

void Input::SetSignaltype(const std::string& value)
{
    m_Signaltype = value;
}
...
const std::string& Input::GetInterpolate() const
{
    return m_Interpolate;
}

void Input::SetInterpolate(const std::string& value)
{
    m_Interpolate = value;
}

const std::string& Input::GetInputconnect() const
{
...
const std::string& Input::GetDatamode() const
{
    return m_Datamode;
}

void Input::SetDatamode(const std::string& value)
{
    m_Datamode = value;
}
...
const std::string& Input::GetEventtriggers() const
{
