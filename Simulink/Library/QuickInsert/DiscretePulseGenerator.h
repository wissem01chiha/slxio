...
#ifndef DISCRETEPULSEGENERATOR_H
#define DISCRETEPULSEGENERATOR_H
...
class SLXIO_APIEXPORT DiscretePulseGenerator : public IBlockParameters, public IBlockProperties
{
public:
  /** Default Constructor */
...
#endif // DISCRETEPULSEGENERATOR_H
