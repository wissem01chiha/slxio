...
const std::string& EulersNumber::GetValue() const
{
  return m_Value;
}

void EulersNumber::SetValue(const std::string& value)
{
  m_Value = value;
}
...
const std::string& EulersNumber::GetOutmin() const
{
  return m_Outmin;
}

void EulersNumber::SetOutmin(const std::string& value)
{
  m_Outmin = value;
}

const std::string& EulersNumber::GetOutmax() const
{
  return m_Outmax;
}

void EulersNumber::SetOutmax(const std::string& value)
{
  m_Outmax = value;
}
...
const std::string& EulersNumber::GetLockscale() const
{
  return m_Lockscale;
}
...
const std::string& EulersNumber::GetSampletime() const
{
  return m_Sampletime;
}
