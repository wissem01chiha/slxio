...
const std::string& SawtoothGenerator::GetWaveform() const
{
  return m_Waveform;
}
...
const std::string& SawtoothGenerator::GetUnits() const
{
  return m_Units;
}

void SawtoothGenerator::SetUnits(const std::string& value)
{
  m_Units = value;
}
