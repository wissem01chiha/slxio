...
const std::string& SquareRoot::GetOperator() const
{
  return m_Operator;
}

void SquareRoot::SetOperator(const std::string& value)
{
  m_Operator = value;
}
...
const std::string& SquareRoot::GetSampletime() const
{
  return m_Sampletime;
}
...
const std::string& SquareRoot::GetOutmin() const
{
  return m_Outmin;
}

void SquareRoot::SetOutmin(const std::string& value)
{
  m_Outmin = value;
}

const std::string& SquareRoot::GetOutmax() const
{
  return m_Outmax;
}

void SquareRoot::SetOutmax(const std::string& value)
{
  m_Outmax = value;
}
...
const std::string& SquareRoot::GetLockscale() const
{
  return m_Lockscale;
}

void SquareRoot::SetLockscale(const std::string& value)
{
  m_Lockscale = value;
}

const std::string& SquareRoot::GetRndmeth() const
{
  return m_Rndmeth;
}

void SquareRoot::SetRndmeth(const std::string& value)
{
  m_Rndmeth = value;
}
...
const std::string& SquareRoot::GetIterations() const
{
  return m_Iterations;
}
