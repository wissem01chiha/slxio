...
const std::string& BitwiseXor::GetLogicop() const { return m_Logicop; }

void BitwiseXor::SetLogicop(const std::string& value) { m_Logicop = value; }

const std::string& BitwiseXor::GetUsebitmask() const { return m_Usebitmask; }
...
const std::string& BitwiseXor::GetBitmask() const { return m_Bitmask; }

void BitwiseXor::SetBitmask(const std::string& value) { m_Bitmask = value; }
