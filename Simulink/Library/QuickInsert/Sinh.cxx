...
const std::string& Sinh::GetOperator() const
{
  return m_Operator;
}

void Sinh::SetOperator(const std::string& value)
{
  m_Operator = value;
}
...
const std::string& Sinh::GetInterpmethod() const
{
  return m_Interpmethod;
}

void Sinh::SetInterpmethod(const std::string& value)
{
  m_Interpmethod = value;
}

const std::string& Sinh::GetAngleunit() const
{
  return m_Angleunit;
}

void Sinh::SetAngleunit(const std::string& value)
{
  m_Angleunit = value;
}
...
const std::string& Sinh::GetSampletime() const
{
  return m_Sampletime;
}

void Sinh::SetSampletime(const std::string& value)
{
  m_Sampletime = value;
}
