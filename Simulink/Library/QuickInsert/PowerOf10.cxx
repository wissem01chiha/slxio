...
const std::string& PowerOf10::GetOperator() const
{
  return m_Operator;
}

void PowerOf10::SetOperator(const std::string& value)
{
  m_Operator = value;
}
...
const std::string& PowerOf10::GetSignedpower() const
{
...
const std::string& PowerOf10::GetSampletime() const
{
  return m_Sampletime;
}
...
const std::string& PowerOf10::GetOutmin() const
{
  return m_Outmin;
}

void PowerOf10::SetOutmin(const std::string& value)
{
  m_Outmin = value;
}

const std::string& PowerOf10::GetOutmax() const
{
  return m_Outmax;
}

void PowerOf10::SetOutmax(const std::string& value)
{
  m_Outmax = value;
}
...
const std::string& PowerOf10::GetLockscale() const
{
  return m_Lockscale;
}

void PowerOf10::SetLockscale(const std::string& value)
{
  m_Lockscale = value;
}

const std::string& PowerOf10::GetRndmeth() const
{
  return m_Rndmeth;
}

void PowerOf10::SetRndmeth(const std::string& value)
{
  m_Rndmeth = value;
}
...
const std::string& PowerOf10::GetIterations() const
{
  return m_Iterations;
}
