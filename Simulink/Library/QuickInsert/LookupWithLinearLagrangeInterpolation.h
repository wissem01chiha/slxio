...
#ifndef LOOKUPWITHLINEARLAGRANGEINTERPOLATION_H
#define LOOKUPWITHLINEARLAGRANGEINTERPOLATION_H
...
class SLXIO_APIEXPORT LookupWithLinearLagrangeInterpolation : public IBlockParameters, public IBlockProperties
{
public:
  /** Default Constructor */
  LookupWithLinearLagrangeInterpolation();
...
#endif // LOOKUPWITHLINEARLAGRANGEINTERPOLATION_H
