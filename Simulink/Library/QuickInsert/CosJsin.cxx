...
const std::string& CosJsin::GetOperator() const { return m_Operator; }

void CosJsin::SetOperator(const std::string& value) { m_Operator = value; }
...
const std::string& CosJsin::GetInterpmethod() const { return m_Interpmethod; }
...
const std::string& CosJsin::GetAngleunit() const { return m_Angleunit; }

void CosJsin::SetAngleunit(const std::string& value) { m_Angleunit = value; }
...
const std::string& CosJsin::GetSampletime() const { return m_Sampletime; }

void CosJsin::SetSampletime(const std::string& value) { m_Sampletime = value; }
