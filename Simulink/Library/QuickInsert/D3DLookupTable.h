...
#ifndef D3DLOOKUPTABLE_H
#define D3DLOOKUPTABLE_H
...
class SLXIO_APIEXPORT D3DLookupTable : public IBlockParameters, public IBlockProperties
{
public:
  /** Default Constructor */
  D3DLookupTable();
