...
const std::string& Outport::GetPort() const
{
  return m_Port;
}

void Outport::SetPort(const std::string& value)
{
  m_Port = value;
}

const std::string& Outport::GetSignalname() const
{
  return m_Signalname;
}

void Outport::SetSignalname(const std::string& value)
{
  m_Signalname = value;
}

const std::string& Outport::GetSignalobject() const
{
...
const std::string& Outport::GetStorageclass() const
{
...
const std::string& Outport::GetIcondisplay() const
{
...
const std::string& Outport::GetOutmin() const
{
  return m_Outmin;
}

void Outport::SetOutmin(const std::string& value)
{
  m_Outmin = value;
}

const std::string& Outport::GetOutmax() const
{
  return m_Outmax;
}

void Outport::SetOutmax(const std::string& value)
{
  m_Outmax = value;
}
...
const std::string& Outport::GetLockscale() const
{
  return m_Lockscale;
}

void Outport::SetLockscale(const std::string& value)
{
  m_Lockscale = value;
}
...
const std::string& Outport::GetBusvirtuality() const
{
...
const std::string& Outport::GetDatamode() const
{
  return m_Datamode;
}

void Outport::SetDatamode(const std::string& value)
{
  m_Datamode = value;
}

const std::string& Outport::GetUnit() const
{
  return m_Unit;
}

void Outport::SetUnit(const std::string& value)
{
  m_Unit = value;
}
...
const std::string& Outport::GetVarsizesig() const
{
  return m_Varsizesig;
}

void Outport::SetVarsizesig(const std::string& value)
{
  m_Varsizesig = value;
}

const std::string& Outport::GetSampletime() const
{
  return m_Sampletime;
}

void Outport::SetSampletime(const std::string& value)
{
  m_Sampletime = value;
}

const std::string& Outport::GetSignaltype() const
{
  return m_Signaltype;
}

void Outport::SetSignaltype(const std::string& value)
{
  m_Signaltype = value;
}
...
const std::string& Outport::GetInitialoutput() const
{
