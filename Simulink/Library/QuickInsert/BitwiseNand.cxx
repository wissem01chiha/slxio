...
const std::string& BitwiseNand::GetLogicop() const { return m_Logicop; }

void BitwiseNand::SetLogicop(const std::string& value) { m_Logicop = value; }

const std::string& BitwiseNand::GetUsebitmask() const { return m_Usebitmask; }
...
const std::string& BitwiseNand::GetBitmask() const { return m_Bitmask; }

void BitwiseNand::SetBitmask(const std::string& value) { m_Bitmask = value; }
