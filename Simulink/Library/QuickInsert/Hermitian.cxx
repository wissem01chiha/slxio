...
const std::string& Hermitian::GetOperator() const { return m_Operator; }

void Hermitian::SetOperator(const std::string& value) { m_Operator = value; }
...
const std::string& Hermitian::GetSignedpower() const { return m_Signedpower; }
...
const std::string& Hermitian::GetSampletime() const { return m_Sampletime; }
...
const std::string& Hermitian::GetOutmin() const { return m_Outmin; }

void Hermitian::SetOutmin(const std::string& value) { m_Outmin = value; }

const std::string& Hermitian::GetOutmax() const { return m_Outmax; }

void Hermitian::SetOutmax(const std::string& value) { m_Outmax = value; }
...
const std::string& Hermitian::GetLockscale() const { return m_Lockscale; }

void Hermitian::SetLockscale(const std::string& value) { m_Lockscale = value; }

const std::string& Hermitian::GetRndmeth() const { return m_Rndmeth; }

void Hermitian::SetRndmeth(const std::string& value) { m_Rndmeth = value; }
...
const std::string& Hermitian::GetIterations() const { return m_Iterations; }
