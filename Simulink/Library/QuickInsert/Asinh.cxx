...
const std::string& Asinh::GetOperator() const { return m_Operator; }

void Asinh::SetOperator(const std::string& value) { m_Operator = value; }
...
const std::string& Asinh::GetInterpmethod() const { return m_Interpmethod; }
...
const std::string& Asinh::GetAngleunit() const { return m_Angleunit; }

void Asinh::SetAngleunit(const std::string& value) { m_Angleunit = value; }
...
const std::string& Asinh::GetSampletime() const { return m_Sampletime; }

void Asinh::SetSampletime(const std::string& value) { m_Sampletime = value; }
