...
const std::string& BitwiseNor::GetLogicop() const
{
    return m_Logicop;
}

void BitwiseNor::SetLogicop(const std::string& value)
{
    m_Logicop = value;
}

const std::string& BitwiseNor::GetUsebitmask() const
{
    return m_Usebitmask;
}
...
const std::string& BitwiseNor::GetBitmask() const
{
    return m_Bitmask;
}

void BitwiseNor::SetBitmask(const std::string& value)
{
    m_Bitmask = value;
}
