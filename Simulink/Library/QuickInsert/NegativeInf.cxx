...
const std::string& NegativeInf::GetValue() const
{
  return m_Value;
}

void NegativeInf::SetValue(const std::string& value)
{
  m_Value = value;
}
...
const std::string& NegativeInf::GetOutmin() const
{
  return m_Outmin;
}

void NegativeInf::SetOutmin(const std::string& value)
{
  m_Outmin = value;
}

const std::string& NegativeInf::GetOutmax() const
{
  return m_Outmax;
}

void NegativeInf::SetOutmax(const std::string& value)
{
  m_Outmax = value;
}
...
const std::string& NegativeInf::GetLockscale() const
{
  return m_Lockscale;
}
...
const std::string& NegativeInf::GetSampletime() const
{
  return m_Sampletime;
}
...
const std::string& NegativeInf::GetFrameperiod() const
{
