...
const std::string& Acosh::GetOperator() const
{
  return m_Operator;
}

void Acosh::SetOperator(const std::string& value)
{
  m_Operator = value;
}
...
const std::string& Acosh::GetInterpmethod() const
{
...
const std::string& Acosh::GetAngleunit() const
{
  return m_Angleunit;
}

void Acosh::SetAngleunit(const std::string& value)
{
  m_Angleunit = value;
}
...
const std::string& Acosh::GetSampletime() const
{
  return m_Sampletime;
}

void Acosh::SetSampletime(const std::string& value)
{
  m_Sampletime = value;
}
