...
const std::string& MaxOfElements::GetFunction() const { return m_Function; }
...
const std::string& MaxOfElements::GetInputs() const { return m_Inputs; }

void MaxOfElements::SetInputs(const std::string& value) { m_Inputs = value; }
...
const std::string& MaxOfElements::GetOutmin() const { return m_Outmin; }

void MaxOfElements::SetOutmin(const std::string& value) { m_Outmin = value; }

const std::string& MaxOfElements::GetOutmax() const { return m_Outmax; }

void MaxOfElements::SetOutmax(const std::string& value) { m_Outmax = value; }
...
const std::string& MaxOfElements::GetLockscale() const { return m_Lockscale; }
...
const std::string& MaxOfElements::GetRndmeth() const { return m_Rndmeth; }

void MaxOfElements::SetRndmeth(const std::string& value) { m_Rndmeth = value; }
...
const std::string& MaxOfElements::GetZerocross() const { return m_Zerocross; }
...
const std::string& MaxOfElements::GetSampletime() const { return m_Sampletime; }
