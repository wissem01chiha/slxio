...
const std::string& Isnonpositive::GetRelop() const { return m_Relop; }

void Isnonpositive::SetRelop(const std::string& value) { m_Relop = value; }
...
const std::string& Isnonpositive::GetZerocross() const { return m_Zerocross; }
