...
const std::string& Transpose::GetOperator() const { return m_Operator; }

void Transpose::SetOperator(const std::string& value) { m_Operator = value; }
...
const std::string& Transpose::GetSignedpower() const { return m_Signedpower; }
...
const std::string& Transpose::GetSampletime() const { return m_Sampletime; }
...
const std::string& Transpose::GetOutmin() const { return m_Outmin; }

void Transpose::SetOutmin(const std::string& value) { m_Outmin = value; }

const std::string& Transpose::GetOutmax() const { return m_Outmax; }

void Transpose::SetOutmax(const std::string& value) { m_Outmax = value; }
...
const std::string& Transpose::GetLockscale() const { return m_Lockscale; }

void Transpose::SetLockscale(const std::string& value) { m_Lockscale = value; }

const std::string& Transpose::GetRndmeth() const { return m_Rndmeth; }

void Transpose::SetRndmeth(const std::string& value) { m_Rndmeth = value; }
...
const std::string& Transpose::GetIterations() const { return m_Iterations; }
