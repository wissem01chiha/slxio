...
const std::string& CastToDouble::GetOutmin() const { return m_Outmin; }

void CastToDouble::SetOutmin(const std::string& value) { m_Outmin = value; }

const std::string& CastToDouble::GetOutmax() const { return m_Outmax; }

void CastToDouble::SetOutmax(const std::string& value) { m_Outmax = value; }
...
const std::string& CastToDouble::GetLockscale() const { return m_Lockscale; }
...
const std::string& CastToDouble::GetRndmeth() const { return m_Rndmeth; }

void CastToDouble::SetRndmeth(const std::string& value) { m_Rndmeth = value; }
...
const std::string& CastToDouble::GetSampletime() const { return m_Sampletime; }
