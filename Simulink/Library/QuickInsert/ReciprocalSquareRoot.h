...
#ifndef RECIPROCALSQUAREROOT_H
#define RECIPROCALSQUAREROOT_H
...
class SLXIO_APIEXPORT ReciprocalSquareRoot : public IBlockParameters, public IBlockProperties
{
public:
  /** Default Constructor */
