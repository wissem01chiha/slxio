...
const std::string& Sincos::GetOperator() const
{
  return m_Operator;
}

void Sincos::SetOperator(const std::string& value)
{
  m_Operator = value;
}
...
const std::string& Sincos::GetInterpmethod() const
{
...
const std::string& Sincos::GetAngleunit() const
{
  return m_Angleunit;
}

void Sincos::SetAngleunit(const std::string& value)
{
  m_Angleunit = value;
}
...
const std::string& Sincos::GetSampletime() const
{
  return m_Sampletime;
}

void Sincos::SetSampletime(const std::string& value)
{
  m_Sampletime = value;
}
