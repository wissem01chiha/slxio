...
#ifndef MAGNITUDESQUARED_H
#define MAGNITUDESQUARED_H
...
class SLXIO_APIEXPORT MagnitudeSquared : public IBlockParameters, public IBlockProperties
{
public:
  /** Default Constructor */
  MagnitudeSquared();
