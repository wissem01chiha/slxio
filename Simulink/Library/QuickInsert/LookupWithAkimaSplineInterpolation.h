...
#ifndef LOOKUPWITHAKIMASPLINEINTERPOLATION_H
#define LOOKUPWITHAKIMASPLINEINTERPOLATION_H
...
class SLXIO_APIEXPORT LookupWithAkimaSplineInterpolation : public IBlockParameters, public IBlockProperties
{
public:
  /** Default Constructor */
  LookupWithAkimaSplineInterpolation();
...
#endif // LOOKUPWITHAKIMASPLINEINTERPOLATION_H
