...
const std::string& MinOfElements::GetFunction() const { return m_Function; }
...
const std::string& MinOfElements::GetInputs() const { return m_Inputs; }

void MinOfElements::SetInputs(const std::string& value) { m_Inputs = value; }
...
const std::string& MinOfElements::GetOutmin() const { return m_Outmin; }

void MinOfElements::SetOutmin(const std::string& value) { m_Outmin = value; }

const std::string& MinOfElements::GetOutmax() const { return m_Outmax; }

void MinOfElements::SetOutmax(const std::string& value) { m_Outmax = value; }
...
const std::string& MinOfElements::GetLockscale() const { return m_Lockscale; }
...
const std::string& MinOfElements::GetRndmeth() const { return m_Rndmeth; }

void MinOfElements::SetRndmeth(const std::string& value) { m_Rndmeth = value; }
...
const std::string& MinOfElements::GetZerocross() const { return m_Zerocross; }
...
const std::string& MinOfElements::GetSampletime() const { return m_Sampletime; }
