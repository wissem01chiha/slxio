...
void DiscreteStateSpace::SetStatemustresolvetosignalobject(const std::string& value)
{
...
void DiscreteStateSpace::SetRtwstatestoragetypequalifier(const std::string& value)
{
