...
#ifndef SETPOINTWEIGHTINGPROPORTIONAL_H
#define SETPOINTWEIGHTINGPROPORTIONAL_H
...
class SLXIO_APIEXPORT SetpointWeightingProportional : public IBlockParameters, public IBlockProperties
{
public:
  /** Default Constructor */
  SetpointWeightingProportional();
...
#endif // SETPOINTWEIGHTINGPROPORTIONAL_H
