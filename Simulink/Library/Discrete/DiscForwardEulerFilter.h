...
#ifndef DISCFORWARDEULERFILTER_H
#define DISCFORWARDEULERFILTER_H
...
class SLXIO_APIEXPORT DiscForwardEulerFilter : public IBlockParameters, public IBlockProperties
{
public:
  /** Default Constructor */
  DiscForwardEulerFilter();
...
#endif // DISCFORWARDEULERFILTER_H
