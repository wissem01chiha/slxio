...
const std::string& TransferFcnRealZero::GetZeroz() const
{
  return m_Zeroz;
}
...
const std::string& TransferFcnRealZero::GetRndmeth() const
{
  return m_Rndmeth;
}
...
const std::string& TransferFcnRealZero::GetDosatur() const
{
  return m_Dosatur;
}
