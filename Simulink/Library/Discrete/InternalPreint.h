...
#ifndef INTERNALPREINT_H
#define INTERNALPREINT_H
...
class SLXIO_APIEXPORT InternalPreint : public IBlockParameters, public IBlockProperties
{
public:
  /** Default Constructor */
  InternalPreint();
