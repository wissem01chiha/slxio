...
#ifndef SATURATIONFDBK_H
#define SATURATIONFDBK_H
...
class SLXIO_APIEXPORT SaturationFdbk : public IBlockParameters, public IBlockProperties
{
public:
  /** Default Constructor */
  SaturationFdbk();
