...
#ifndef SIGNALSPECIFICATION1_H
#define SIGNALSPECIFICATION1_H
...
class SLXIO_APIEXPORT SignalSpecification1 : public IBlockParameters, public IBlockProperties
{
public:
  /** Default Constructor */
  SignalSpecification1();
