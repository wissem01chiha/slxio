...
const std::string&
EnabledDelay::GetRemovedelaylengthcheckingeneratedcode() const
{
...
const std::string& EnabledDelay::GetSampletime() const { return m_Sampletime; }
...
const std::string& EnabledDelay::GetStatename() const { return m_Statename; }
