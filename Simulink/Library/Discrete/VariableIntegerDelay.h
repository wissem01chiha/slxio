...
#ifndef VARIABLEINTEGERDELAY_H
#define VARIABLEINTEGERDELAY_H
...
class SLXIO_APIEXPORT VariableIntegerDelay : public IBlockParameters, public IBlockProperties
{
public:
  /** Default Constructor */
