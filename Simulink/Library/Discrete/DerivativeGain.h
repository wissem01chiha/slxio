...
#ifndef DERIVATIVEGAIN_H
#define DERIVATIVEGAIN_H
...
class SLXIO_APIEXPORT DerivativeGain : public IBlockParameters, public IBlockProperties
{
public:
  /** Default Constructor */
  DerivativeGain();
