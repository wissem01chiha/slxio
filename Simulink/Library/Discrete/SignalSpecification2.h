...
#ifndef SIGNALSPECIFICATION2_H
#define SIGNALSPECIFICATION2_H
...
class SLXIO_APIEXPORT SignalSpecification2 : public IBlockParameters, public IBlockProperties
{
public:
  /** Default Constructor */
  SignalSpecification2();
