...
#ifndef DISCRETEPIDCONTROLLER2DOF_H
#define DISCRETEPIDCONTROLLER2DOF_H
...
class SLXIO_APIEXPORT DiscretePidController2dof : public IBlockParameters, public IBlockProperties
{
public:
  /** Default Constructor */
  ...
  const std::string& GetBgainoutdatatypestr() const;
  void SetBgainoutdatatypestr(const std::string& value);

  const std::string& GetBprodoutdatatypestr() const;
  void SetBprodoutdatatypestr(const std::string& value);

  const std::string& GetBoutmin() const;
  void SetBoutmin(const std::string& value);

  const std::string& GetBoutmax() const;
  void SetBoutmax(const std::string& value);

  const std::string& GetCgainoutdatatypestr() const;
  void SetCgainoutdatatypestr(const std::string& value);

  const std::string& GetCprodoutdatatypestr() const;
  void SetCprodoutdatatypestr(const std::string& value);

  const std::string& GetCoutmin() const;
  void SetCoutmin(const std::string& value);

  const std::string& GetCoutmax() const;
  void SetCoutmax(const std::string& value);
  ...
  const std::string& GetBparamdatatypestr() const;
  void SetBparamdatatypestr(const std::string& value);

  const std::string& GetBparammin() const;
  void SetBparammin(const std::string& value);

  const std::string& GetBparammax() const;
  void SetBparammax(const std::string& value);

  const std::string& GetCparamdatatypestr() const;
  void SetCparamdatatypestr(const std::string& value);

  const std::string& GetCparammin() const;
  void SetCparammin(const std::string& value);

  const std::string& GetCparammax() const;
  void SetCparammax(const std::string& value);
  ...
  const std::string& GetSum1outdatatypestr() const;
  void SetSum1outdatatypestr(const std::string& value);

  const std::string& GetSum1outmin() const;
  void SetSum1outmin(const std::string& value);

  const std::string& GetSum1outmax() const;
  void SetSum1outmax(const std::string& value);

  const std::string& GetSum2outdatatypestr() const;
  void SetSum2outdatatypestr(const std::string& value);

  const std::string& GetSum2outmin() const;
  void SetSum2outmin(const std::string& value);

  const std::string& GetSum2outmax() const;
  void SetSum2outmax(const std::string& value);

  const std::string& GetSum3outdatatypestr() const;
  void SetSum3outdatatypestr(const std::string& value);

  const std::string& GetSum3outmin() const;
  void SetSum3outmin(const std::string& value);

  const std::string& GetSum3outmax() const;
  void SetSum3outmax(const std::string& value);
  ...
  const std::string& GetSum1accumdatatypestr() const;
  void SetSum1accumdatatypestr(const std::string& value);

  const std::string& GetSum2accumdatatypestr() const;
  void SetSum2accumdatatypestr(const std::string& value);

  const std::string& GetSum3accumdatatypestr() const;
  void SetSum3accumdatatypestr(const std::string& value);
...
private:
  ...
  std::string m_Bgainoutdatatypestr;

  std::string m_Bprodoutdatatypestr;

  std::string m_Boutmin;

  std::string m_Boutmax;

  std::string m_Cgainoutdatatypestr;

  std::string m_Cprodoutdatatypestr;

  std::string m_Coutmin;

  std::string m_Coutmax;
  ...
  std::string m_Bparamdatatypestr;

  std::string m_Bparammin;

  std::string m_Bparammax;

  std::string m_Cparamdatatypestr;

  std::string m_Cparammin;

  std::string m_Cparammax;
  ...
  std::string m_Sum1outdatatypestr;

  std::string m_Sum1outmin;

  std::string m_Sum1outmax;

  std::string m_Sum2outdatatypestr;

  std::string m_Sum2outmin;

  std::string m_Sum2outmax;

  std::string m_Sum3outdatatypestr;

  std::string m_Sum3outmin;

  std::string m_Sum3outmax;
  ...
  std::string m_Sum1accumdatatypestr;

  std::string m_Sum2accumdatatypestr;

  std::string m_Sum3accumdatatypestr;
...
#endif // DISCRETEPIDCONTROLLER2DOF_H
