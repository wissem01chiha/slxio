...
const std::string& DiscretePidController::GetInitialconditionforintegrator()
  const
{
...
const std::string& DiscretePidController::GetDifferentiatoricprevscaledinput()
  const
{
...
const std::string& DiscretePidController::GetUpperintegratorsaturationlimit()
  const
{
...
const std::string& DiscretePidController::GetLowerintegratorsaturationlimit()
  const
{
...
const std::string& DiscretePidController::GetDifferentiatoroutdatatypestr()
  const
{
...
const std::string& DiscretePidController::GetFilterdiffnumaccumdatatypestr()
  const
{
...
const std::string& DiscretePidController::GetFilterdiffdenaccumdatatypestr()
  const
{
...
const std::string& DiscretePidController::GetFilterdiffoutcoefdatatypestr()
  const
{
...
const std::string& DiscretePidController::GetUintegraltsprodoutdatatypestr()
  const
{
...
const std::string& DiscretePidController::GetFilterdenconstantoutdatatypestr()
  const
{
...
const std::string& DiscretePidController::GetFiltercontinuousstateattributes()
  const
{
