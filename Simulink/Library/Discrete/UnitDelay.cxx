...
const std::string& UnitDelay::GetSampletime() const { return m_Sampletime; }
...
const std::string& UnitDelay::GetStatename() const { return m_Statename; }

void UnitDelay::SetStatename(const std::string& value) { m_Statename = value; }
