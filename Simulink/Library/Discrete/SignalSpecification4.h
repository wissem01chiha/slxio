...
#ifndef SIGNALSPECIFICATION4_H
#define SIGNALSPECIFICATION4_H
...
class SLXIO_APIEXPORT SignalSpecification4 : public IBlockParameters, public IBlockProperties
{
public:
  /** Default Constructor */
  SignalSpecification4();
