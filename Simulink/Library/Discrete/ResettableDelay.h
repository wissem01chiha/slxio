...
#ifndef RESETTABLEDELAY_H
#define RESETTABLEDELAY_H
...
class SLXIO_APIEXPORT ResettableDelay : public IBlockParameters, public IBlockProperties
{
public:
  /** Default Constructor */
  ResettableDelay();
