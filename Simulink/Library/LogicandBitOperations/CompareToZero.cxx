...
const std::string& CompareToZero::GetRelop() const { return m_Relop; }

void CompareToZero::SetRelop(const std::string& value) { m_Relop = value; }
...
const std::string& CompareToZero::GetZerocross() const { return m_Zerocross; }
