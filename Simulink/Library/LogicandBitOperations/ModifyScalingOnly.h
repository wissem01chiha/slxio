...
#ifndef MODIFYSCALINGONLY_H
#define MODIFYSCALINGONLY_H
...
class SLXIO_APIEXPORT ModifyScalingOnly : public IBlockParameters, public IBlockProperties
{
public:
  /** Default Constructor */
  ModifyScalingOnly();
