...
#ifndef FIXPTBITWISEOPERATOR3_H
#define FIXPTBITWISEOPERATOR3_H
...
class SLXIO_APIEXPORT FixptBitwiseOperator3 : public IBlockParameters, public IBlockProperties
{
public:
  /** Default Constructor */
  FixptBitwiseOperator3();
