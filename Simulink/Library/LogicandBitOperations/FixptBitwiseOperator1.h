...
#ifndef FIXPTBITWISEOPERATOR1_H
#define FIXPTBITWISEOPERATOR1_H
...
class SLXIO_APIEXPORT FixptBitwiseOperator1 : public IBlockParameters, public IBlockProperties
{
public:
  /** Default Constructor */
  FixptBitwiseOperator1();
