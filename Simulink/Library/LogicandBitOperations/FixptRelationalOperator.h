...
#ifndef FIXPTRELATIONALOPERATOR_H
#define FIXPTRELATIONALOPERATOR_H
...
class SLXIO_APIEXPORT FixptRelationalOperator : public IBlockParameters, public IBlockProperties
{
public:
  /** Default Constructor */
...
#endif // FIXPTRELATIONALOPERATOR_H
