...
#ifndef EXTRACTDESIREDBITS_H
#define EXTRACTDESIREDBITS_H
...
class SLXIO_APIEXPORT ExtractDesiredBits : public IBlockParameters, public IBlockProperties
{
public:
  /** Default Constructor */
  ExtractDesiredBits();
