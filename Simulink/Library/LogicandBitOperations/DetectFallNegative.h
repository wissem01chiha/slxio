...
#ifndef DETECTFALLNEGATIVE_H
#define DETECTFALLNEGATIVE_H
...
class SLXIO_APIEXPORT DetectFallNegative : public IBlockParameters, public IBlockProperties
{
public:
  /** Default Constructor */
  DetectFallNegative();
