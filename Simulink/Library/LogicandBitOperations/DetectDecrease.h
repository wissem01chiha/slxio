...
#ifndef DETECTDECREASE_H
#define DETECTDECREASE_H
...
class SLXIO_APIEXPORT DetectDecrease : public IBlockParameters, public IBlockProperties
{
public:
  /** Default Constructor */
  DetectDecrease();
