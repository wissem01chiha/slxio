...
#ifndef DETECTRISEPOSITIVE_H
#define DETECTRISEPOSITIVE_H
...
class SLXIO_APIEXPORT DetectRisePositive : public IBlockParameters, public IBlockProperties
{
public:
  /** Default Constructor */
  DetectRisePositive();
