...
#ifndef BITWISEOPERATOR_H
#define BITWISEOPERATOR_H
...
class SLXIO_APIEXPORT BitwiseOperator : public IBlockParameters, public IBlockProperties
{
public:
  /** Default Constructor */
  BitwiseOperator();
