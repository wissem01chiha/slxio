...
#ifndef FIXPTBITWISEOPERATOR4_H
#define FIXPTBITWISEOPERATOR4_H
...
class SLXIO_APIEXPORT FixptBitwiseOperator4 : public IBlockParameters, public IBlockProperties
{
public:
  /** Default Constructor */
  FixptBitwiseOperator4();
