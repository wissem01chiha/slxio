...
#ifndef DETECTFALLNONPOSITIVE_H
#define DETECTFALLNONPOSITIVE_H
...
class SLXIO_APIEXPORT DetectFallNonpositive : public IBlockParameters, public IBlockProperties
{
public:
  /** Default Constructor */
