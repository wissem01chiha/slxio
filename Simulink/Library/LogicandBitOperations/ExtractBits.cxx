...
const std::string& ExtractBits::GetNumbits() const { return m_Numbits; }

void ExtractBits::SetNumbits(const std::string& value) { m_Numbits = value; }

const std::string& ExtractBits::GetBitidxrange() const { return m_Bitidxrange; }
