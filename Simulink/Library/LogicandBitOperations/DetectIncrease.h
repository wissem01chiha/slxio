...
#ifndef DETECTINCREASE_H
#define DETECTINCREASE_H
...
class SLXIO_APIEXPORT DetectIncrease : public IBlockParameters, public IBlockProperties
{
public:
  /** Default Constructor */
  DetectIncrease();
