...
#ifndef ADDITIONALMATHINCREMENTDECREMENT_H
#define ADDITIONALMATHINCREMENTDECREMENT_H
...
class SLXIO_APIEXPORT AdditionalMathIncrementDecrement
    : public IBlockParameters,
      public IBlockProperties
{
public:
    /** Default Constructor */
    AdditionalMathIncrementDecrement();
...
#endif // ADDITIONALMATHINCREMENTDECREMENT_H
