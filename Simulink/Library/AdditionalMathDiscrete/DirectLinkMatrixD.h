...
#ifndef DIRECTLINKMATRIXD_H
#define DIRECTLINKMATRIXD_H
...
class SLXIO_APIEXPORT DirectLinkMatrixD : public IBlockParameters, public IBlockProperties
{
public:
  /** Default Constructor */
  DirectLinkMatrixD();
