...
#ifndef FIXPTGATEWAYIN_H
#define FIXPTGATEWAYIN_H
...
class SLXIO_APIEXPORT FixptGatewayIn : public IBlockParameters, public IBlockProperties
{
public:
  /** Default Constructor */
  FixptGatewayIn();
