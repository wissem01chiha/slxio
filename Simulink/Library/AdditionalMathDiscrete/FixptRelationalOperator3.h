...
#ifndef FIXPTRELATIONALOPERATOR3_H
#define FIXPTRELATIONALOPERATOR3_H
...
class SLXIO_APIEXPORT FixptRelationalOperator3 : public IBlockParameters, public IBlockProperties
{
public:
  /** Default Constructor */
  FixptRelationalOperator3();
...
#endif // FIXPTRELATIONALOPERATOR3_H
