...
#ifndef SUMSTATEEQUATION_H
#define SUMSTATEEQUATION_H
...
class SLXIO_APIEXPORT SumStateEquation : public IBlockParameters, public IBlockProperties
{
public:
  /** Default Constructor */
  SumStateEquation();
