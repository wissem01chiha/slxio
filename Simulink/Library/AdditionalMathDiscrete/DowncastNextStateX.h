...
#ifndef DOWNCASTNEXTSTATEX_H
#define DOWNCASTNEXTSTATEX_H
...
class SLXIO_APIEXPORT DowncastNextStateX : public IBlockParameters, public IBlockProperties
{
public:
  /** Default Constructor */
  DowncastNextStateX();
