...
#ifndef SUMOUTPUTEQUATION_H
#define SUMOUTPUTEQUATION_H
...
class SLXIO_APIEXPORT SumOutputEquation : public IBlockParameters, public IBlockProperties
{
public:
  /** Default Constructor */
  SumOutputEquation();
