...
#ifndef FIXPTSAMPLETIMEMATH_H
#define FIXPTSAMPLETIMEMATH_H
...
class SLXIO_APIEXPORT FixptSampleTimeMath : public IBlockParameters, public IBlockProperties
{
public:
  /** Default Constructor */
  FixptSampleTimeMath();
