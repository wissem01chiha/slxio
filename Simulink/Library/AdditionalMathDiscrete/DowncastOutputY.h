...
#ifndef DOWNCASTOUTPUTY_H
#define DOWNCASTOUTPUTY_H
...
class SLXIO_APIEXPORT DowncastOutputY : public IBlockParameters, public IBlockProperties
{
public:
  /** Default Constructor */
  DowncastOutputY();
