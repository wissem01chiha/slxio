...
const std::string& ToWorkspace::GetDecimation() const { return m_Decimation; }
...
const std::string& ToWorkspace::GetSaveformat() const { return m_Saveformat; }
...
const std::string& ToWorkspace::GetFixptasfi() const { return m_Fixptasfi; }
...
const std::string& ToWorkspace::GetSampletime() const { return m_Sampletime; }
