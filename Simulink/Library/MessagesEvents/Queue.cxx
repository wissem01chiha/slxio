...
const std::string& Queue::GetCapacity() const
{
  return m_Capacity;
}

void Queue::SetCapacity(const std::string& value)
{
  m_Capacity = value;
}

const std::string& Queue::GetQueuetype() const
{
  return m_Queuetype;
}

void Queue::SetQueuetype(const std::string& value)
{
  m_Queuetype = value;
}

const std::string& Queue::GetPrioritysource() const
{
  return m_Prioritysource;
}
...
const std::string& Queue::GetMulticasttag() const
{
  return m_Multicasttag;
}
...
const std::string& Queue::GetEntryaction() const
{
  return m_Entryaction;
}

void Queue::SetEntryaction(const std::string& value)
{
  m_Entryaction = value;
}

const std::string& Queue::GetExitaction() const
{
  return m_Exitaction;
}

void Queue::SetExitaction(const std::string& value)
{
  m_Exitaction = value;
}

const std::string& Queue::GetBlockedaction() const
{
  return m_Blockedaction;
}
...
const std::string& Queue::GetAveragewait() const
{
  return m_Averagewait;
}

void Queue::SetAveragewait(const std::string& value)
{
  m_Averagewait = value;
}
