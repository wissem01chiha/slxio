...
const std::string& Receive::GetQueuelength() const
{
...
const std::string& Receive::GetQueuetype() const
{
  return m_Queuetype;
}

void Receive::SetQueuetype(const std::string& value)
{
  m_Queuetype = value;
}

const std::string& Receive::GetPriorityorder() const
{
...
const std::string& Receive::GetInitialvalue() const
{
...
const std::string& Receive::GetSampletime() const
{
  return m_Sampletime;
}

void Receive::SetSampletime(const std::string& value)
{
  m_Sampletime = value;
}
