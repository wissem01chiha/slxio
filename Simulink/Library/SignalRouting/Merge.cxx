...
const std::string& Merge::GetInputs() const { return m_Inputs; }

void Merge::SetInputs(const std::string& value) { m_Inputs = value; }

const std::string& Merge::GetInitialoutput() const { return m_Initialoutput; }
