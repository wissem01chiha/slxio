...
const std::string& DataStoreWrite::GetIndexmode() const
{
    return m_Indexmode;
}
...
const std::string& DataStoreWrite::GetIndices() const
{
    return m_Indices;
}

void DataStoreWrite::SetIndices(const std::string& value)
{
    m_Indices = value;
}
