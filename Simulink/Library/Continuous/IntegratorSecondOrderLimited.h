...
#ifndef INTEGRATORSECONDORDERLIMITED_H
#define INTEGRATORSECONDORDERLIMITED_H
...
class SLXIO_APIEXPORT IntegratorSecondOrderLimited : public IBlockParameters, public IBlockProperties
{
public:
  /** Default Constructor */
  IntegratorSecondOrderLimited();
...
#endif // INTEGRATORSECONDORDERLIMITED_H
