...
#ifndef PIDCONTROLLER2DOF_H
#define PIDCONTROLLER2DOF_H
...
class SLXIO_APIEXPORT PidController2dof : public IBlockParameters, public IBlockProperties
{
public:
  /** Default Constructor */
  PidController2dof();
