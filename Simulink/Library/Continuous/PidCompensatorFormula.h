...
#ifndef PIDCOMPENSATORFORMULA_H
#define PIDCOMPENSATORFORMULA_H
...
class SLXIO_APIEXPORT PidCompensatorFormula : public IBlockParameters, public IBlockProperties
{
public:
  /** Default Constructor */
  PidCompensatorFormula();
