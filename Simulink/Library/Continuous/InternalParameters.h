...
#ifndef INTERNALPARAMETERS_H
#define INTERNALPARAMETERS_H
...
class SLXIO_APIEXPORT InternalParameters : public IBlockParameters, public IBlockProperties
{
public:
  /** Default Constructor */
  InternalParameters();
