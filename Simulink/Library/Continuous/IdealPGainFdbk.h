...
#ifndef IDEALPGAINFDBK_H
#define IDEALPGAINFDBK_H
...
class SLXIO_APIEXPORT IdealPGainFdbk : public IBlockParameters, public IBlockProperties
{
public:
  /** Default Constructor */
  IdealPGainFdbk();
