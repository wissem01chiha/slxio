...
#ifndef VARIABLETIMEDELAY_H
#define VARIABLETIMEDELAY_H
...
class SLXIO_APIEXPORT VariableTimeDelay : public IBlockParameters, public IBlockProperties
{
public:
  /** Default Constructor */
  VariableTimeDelay();
