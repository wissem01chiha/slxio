...
#ifndef PROPORTIONALGAIN_H
#define PROPORTIONALGAIN_H
...
class SLXIO_APIEXPORT ProportionalGain : public IBlockParameters, public IBlockProperties
{
public:
  /** Default Constructor */
  ProportionalGain();
