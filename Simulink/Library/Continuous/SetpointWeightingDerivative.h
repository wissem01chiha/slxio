...
#ifndef SETPOINTWEIGHTINGDERIVATIVE_H
#define SETPOINTWEIGHTINGDERIVATIVE_H
...
class SLXIO_APIEXPORT SetpointWeightingDerivative : public IBlockParameters, public IBlockProperties
{
public:
  /** Default Constructor */
  SetpointWeightingDerivative();
...
#endif // SETPOINTWEIGHTINGDERIVATIVE_H
