...
#ifndef TRACKINGMODESUM_H
#define TRACKINGMODESUM_H
...
class SLXIO_APIEXPORT TrackingModeSum : public IBlockParameters, public IBlockProperties
{
public:
  /** Default Constructor */
  TrackingModeSum();
