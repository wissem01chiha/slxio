...
#ifndef EXTERNALDERIVATIVE_H
#define EXTERNALDERIVATIVE_H
...
class SLXIO_APIEXPORT ExternalDerivative : public IBlockParameters, public IBlockProperties
{
public:
  /** Default Constructor */
  ExternalDerivative();
