...
std::shared_ptr<StateflowNodeBase> StateflowTransition::getSrc() const { return src; }
std::shared_ptr<StateflowNodeBase> StateflowTransition::getDst() const { return dst; }
...
void StateflowTransition::remove() {
    if (src) {
        src->removeOutTransition(std::shared_ptr<StateflowTransition>(this, [](StateflowTransition*){}));
        src.reset();
    }
    if (dst) {
        dst->removeInTransition(std::shared_ptr<StateflowTransition>(this, [](StateflowTransition*){}));
        dst.reset();
    }
}
