    ...
    : dst(dst)
{
    ...
    dst->addInTransition(std::shared_ptr<StateflowTransition>(
        this, [](StateflowTransition*) {}));
}
    ...
    : src(src), dst(dst)
{
    ...
    src->addOutTransition(std::shared_ptr<StateflowTransition>(
        this, [](StateflowTransition*) {}));
    dst->addInTransition(std::shared_ptr<StateflowTransition>(
        this, [](StateflowTransition*) {}));
}
...
void StateflowTransition::RemoveElement()
{
    if (src)
    {
        src->removeOutTransition(std::shared_ptr<StateflowTransition>(
            this, [](StateflowTransition*) {}));
        src.reset();
    }
    if (dst)
    {
        dst->removeInTransition(std::shared_ptr<StateflowTransition>(
            this, [](StateflowTransition*) {}));
        dst.reset();
    }
}
