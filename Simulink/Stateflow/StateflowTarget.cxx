...
HError
StateflowTarget::RemoveElement(std::shared_ptr<SimulinkElementBase> element) {
...
HError
StateflowTarget::AddElement(std::shared_ptr<SimulinkElementBase> element) {
  return E_OK;
}

std::string StateflowTarget::toString() const { return std::string(""); }

SId StateflowTarget::GetId() const { return (SId)0; }
