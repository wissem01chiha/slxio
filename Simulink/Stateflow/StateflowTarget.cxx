...
SResult StateflowTarget::RemoveElement(std::shared_ptr<SimulinkElementBase> element)
{
...
SResult StateflowTarget::AddElement(std::shared_ptr<SimulinkElementBase> element)
{
  return E_OK;
}
