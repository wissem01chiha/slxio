...
if (USE_CLANG_FORMAT STREQUAL "DISABLED")
  ...
  if (CLANGFORMAT_EXECUTABLE)
    ...
    file (GLOB_RECURSE ALL_SRC_CXX_FILES "${CMAKE_SOURCE_DIR}/*.cxx")
    file (GLOB_RECURSE ALL_HEADER_FILES "${CMAKE_SOURCE_DIR}/*.h"
          "${CMAKE_SOURCE_DIR}/*.hpp" "${CMAKE_SOURCE_DIR}/*.hxx")
    ...
    if (ALL_SRC_CXX_FILES OR ALL_HEADER_FILES)
      add_custom_target (
        format
        COMMAND ${CLANGFORMAT_EXECUTABLE} -i --style=file ${ALL_SRC_CXX_FILES}
                ${ALL_HEADER_FILES}
