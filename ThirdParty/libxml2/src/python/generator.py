...
functions = {
    ...
    "xmlURISetAuthority": (
        ...
        [
            ["URI", "xmlURI *", "the URI"],
            ["authority", "char *", "The URI authority part"],
        ],
        "python_accessor",
        None,
    ),
    ...
    "xmlURISetQueryRaw": (
        ...
        [
            ["URI", "xmlURI *", "the URI"],
            ["query_raw", "char *", "The raw URI query part"],
        ],
        "python_accessor",
        None,
    ),
    ...
    "xmlURISetFragment": (
        ...
        [
            ["URI", "xmlURI *", "the URI"],
            ["fragment", "char *", "The URI fragment part"],
        ],
        "python_accessor",
        None,
    ),
        ...
        if kind == "func":
            for func in section.findall("memberdef"):
                ...
                rtype = etree.tostring(
                    func.find("type"), method="text", encoding=encoding
                ).rstrip()
                ...
                for arg in func.findall("param"):
                    atype = etree.tostring(
                        arg.find("type"), method="text", encoding=encoding
                    ).rstrip()
                    if atype == "void":
                        continue
        ...
        if classname == "None":
            ...
            if classname in classes_ancestor:
                ...
                if (
                    ...
                    classes.write(
                        "('%s got a wrong wrapper object type')\n" % classname
                    )
