...
def run_test(
    ...
    opts = (
        libxml2.XML_PARSE_DTDLOAD | libxml2.XML_PARSE_NONET | libxml2.XML_PARSE_COMPACT
    )
    actual_err = []
...
run_test(
    ...
    exp_err=[
        ...
        (
            -1,
            'failed to load "py://strings/xml/sample.xml": No such file or directory\n',
        ),
    ],
)
...
run_test(
    ...
    exp_err=[
        (
            3,
            'failed to load "py://strings/dtds/sample.dtd": No such file or directory\n',
        ),
        (4, "Entity 'sample.entity' not defined\n"),
    ],
)
