...
XMLPUBFUN int xmlStrQEqual(const xmlChar *pref, const xmlChar *name,
                           const xmlChar *str);
...
XMLPUBFUN xmlChar *xmlStrncatNew(const xmlChar *str1, const xmlChar *str2,
                                 int len);
XMLPUBFUN int xmlStrPrintf(xmlChar *buf, int len, const char *msg, ...)
    LIBXML_ATTR_FORMAT(3, 4);
XMLPUBFUN int xmlStrVPrintf(xmlChar *buf, int len, const char *msg, va_list ap)
