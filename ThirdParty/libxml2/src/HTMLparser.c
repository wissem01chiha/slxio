...
#define IS_HEX_DIGIT(c)                                                        \
  ((IS_ASCII_DIGIT(c)) || ((((c) | 0x20) >= 'a') && (((c) | 0x20) <= 'f')))
 ...
 */
static void htmlErrMemory(xmlParserCtxtPtr ctxt) { xmlCtxtErrMemory(ctxt); }
...
static void LIBXML_ATTR_FORMAT(3, 0)
    htmlParseErr(xmlParserCtxtPtr ctxt, xmlParserErrors error, const char *msg,
                 const xmlChar *str1, const xmlChar *str2) {
  xmlCtxtErr(ctxt, NULL, XML_FROM_HTML, error, XML_ERR_ERROR, str1, str2, NULL,
             0, msg, str1, str2);
}
...
static int htmlNodeInfoPush(htmlParserCtxtPtr ctxt, htmlParserNodeInfo *value) {
  if (ctxt->nodeInfoNr >= ctxt->nodeInfoMax) {
    ...
    newSize =
        xmlGrowCapacity(ctxt->nodeInfoMax, sizeof(tmp[0]), 5, XML_MAX_ITEMS);
    if (newSize < 0) {
      htmlErrMemory(ctxt);
      return (0);
    }
...
static xmlChar *htmlFindEncoding(xmlParserCtxtPtr ctxt) {
  ...
  cur += 8;
  start = cur;
  while ((IS_ALNUM(*cur)) || (*cur == '-') || (*cur == '_') || (*cur == ':') ||
         (*cur == '/'))
    cur++;
  if (cur == start)
    return (NULL);
...
static int htmlValidateUtf8(xmlParserCtxtPtr ctxt, const xmlChar *str,
  ...
  if (c < 0xC2) {
    ...
    if (((v & 0x00C0C0C0) != 0x00808080) || (v < 0xF0900000) ||
        (v >= 0xF4900000))
      goto invalid;
...
static const htmlElemDesc html40ElementTable[] = {
    ...
    {"abbr", 0, 0, 0, 0, 0, 0, 1, "abbreviated form", NULL, NULL, NULL, NULL,
     NULL, 0},
    {"acronym", 0, 0, 0, 0, 0, 0, 1, "", NULL, NULL, NULL, NULL, NULL, 0},
    {"address", 0, 0, 0, 0, 0, 0, 0, "information on author ", NULL, NULL, NULL,
     NULL, NULL, 0},
    {"applet", 0, 0, 0, 0, 1, 1, 2, "java applet ", NULL, NULL, NULL, NULL,
     NULL, 0},
    {"area", 0, 2, 2, 1, 0, 0, 0, "client-side image map area ", NULL, NULL,
     NULL, NULL, NULL, 0},
    {"b", 0, 3, 0, 0, 0, 0, 1, "bold text style", NULL, NULL, NULL, NULL, NULL,
     0},
    {"base", 0, 2, 2, 1, 0, 0, 0, "document base uri ", NULL, NULL, NULL, NULL,
     NULL, 0},
    {"basefont", 0, 2, 2, 1, 1, 1, 1, "base font size ", NULL, NULL, NULL, NULL,
     NULL, 0},
    {"bdo", 0, 0, 0, 0, 0, 0, 1, "i18n bidi over-ride ", NULL, NULL, NULL, NULL,
     NULL, 0},
    {"bgsound", 0, 0, 2, 1, 0, 0, 0, "", NULL, NULL, NULL, NULL, NULL, 0},
    {"big", 0, 3, 0, 0, 0, 0, 1, "large text style", NULL, NULL, NULL, NULL,
     NULL, 0},
    {"blockquote", 0, 0, 0, 0, 0, 0, 0, "long quotation ", NULL, NULL, NULL,
     NULL, NULL, 0},
    {"body", 1, 1, 0, 0, 0, 0, 0, "document body ", NULL, NULL, NULL, NULL,
     NULL, 0},
    {"br", 0, 2, 2, 1, 0, 0, 1, "forced line break ", NULL, NULL, NULL, NULL,
     NULL, 0},
    {"button", 0, 0, 0, 0, 0, 0, 2, "push button ", NULL, NULL, NULL, NULL,
     NULL, 0},
    {"caption", 0, 0, 0, 0, 0, 0, 0, "table caption ", NULL, NULL, NULL, NULL,
     NULL, 0},
    {"center", 0, 3, 0, 0, 1, 1, 0, "shorthand for div align=center ", NULL,
     NULL, NULL, NULL, NULL, 0},
    {"cite", 0, 0, 0, 0, 0, 0, 1, "citation", NULL, NULL, NULL, NULL, NULL, 0},
    {"code", 0, 0, 0, 0, 0, 0, 1, "computer code fragment", NULL, NULL, NULL,
     NULL, NULL, 0},
    {"col", 0, 2, 2, 1, 0, 0, 0, "table column ", NULL, NULL, NULL, NULL, NULL,
     0},
    {"colgroup", 0, 1, 0, 0, 0, 0, 0, "table column group ", NULL, NULL, NULL,
     NULL, NULL, 0},
    {"dd", 0, 1, 0, 0, 0, 0, 0, "definition description ", NULL, NULL, NULL,
     NULL, NULL, 0},
    {"del", 0, 0, 0, 0, 0, 0, 2, "deleted text ", NULL, NULL, NULL, NULL, NULL,
     0},
    {"dfn", 0, 0, 0, 0, 0, 0, 1, "instance definition", NULL, NULL, NULL, NULL,
     NULL, 0},
    {"dir", 0, 0, 0, 0, 1, 1, 0, "directory list", NULL, NULL, NULL, NULL, NULL,
     0},
    {"div", 0, 0, 0, 0, 0, 0, 0, "generic language/style container", NULL, NULL,
     NULL, NULL, NULL, 0},
    {"dl", 0, 0, 0, 0, 0, 0, 0, "definition list ", NULL, NULL, NULL, NULL,
     NULL, 0},
    {"dt", 0, 1, 0, 0, 0, 0, 0, "definition term ", NULL, NULL, NULL, NULL,
     NULL, 0},
    {"em", 0, 3, 0, 0, 0, 0, 1, "emphasis", NULL, NULL, NULL, NULL, NULL, 0},
    {"embed", 0, 1, 2, 1, 1, 1, 1, "generic embedded object ", NULL, NULL, NULL,
     NULL, NULL, 0},
    {"fieldset", 0, 0, 0, 0, 0, 0, 0, "form control group ", NULL, NULL, NULL,
     NULL, NULL, 0},
    {"font", 0, 3, 0, 0, 1, 1, 1, "local change to font ", NULL, NULL, NULL,
     NULL, NULL, 0},
    {"form", 0, 0, 0, 0, 0, 0, 0, "interactive form ", NULL, NULL, NULL, NULL,
     NULL, 0},
    {"frame", 0, 2, 2, 1, 0, 2, 0, "subwindow ", NULL, NULL, NULL, NULL, NULL,
     0},
    {"frameset", 0, 0, 0, 0, 0, 2, 0, "window subdivision", NULL, NULL, NULL,
     NULL, NULL, 0},
    ...
    {"head", 1, 1, 0, 0, 0, 0, 0, "document head ", NULL, NULL, NULL, NULL,
     NULL, 0},
    {"hr", 0, 2, 2, 1, 0, 0, 0, "horizontal rule ", NULL, NULL, NULL, NULL,
     NULL, 0},
    {"html", 1, 1, 0, 0, 0, 0, 0, "document root element ", NULL, NULL, NULL,
     NULL, NULL, 0},
    {"i", 0, 3, 0, 0, 0, 0, 1, "italic text style", NULL, NULL, NULL, NULL,
     NULL, 0},
    {"iframe", 0, 0, 0, 0, 0, 1, 2, "inline subwindow ", NULL, NULL, NULL, NULL,
     NULL, DATA_RAWTEXT},
    {"img", 0, 2, 2, 1, 0, 0, 1, "embedded image ", NULL, NULL, NULL, NULL,
     NULL, 0},
    {"input", 0, 2, 2, 1, 0, 0, 1, "form control ", NULL, NULL, NULL, NULL,
     NULL, 0},
    {"ins", 0, 0, 0, 0, 0, 0, 2, "inserted text", NULL, NULL, NULL, NULL, NULL,
     0},
    {"isindex", 0, 2, 2, 1, 1, 1, 0, "single line prompt ", NULL, NULL, NULL,
     NULL, NULL, 0},
    {"kbd", 0, 0, 0, 0, 0, 0, 1, "text to be entered by the user", NULL, NULL,
     NULL, NULL, NULL, 0},
    {"keygen", 0, 0, 2, 1, 0, 0, 0, "", NULL, NULL, NULL, NULL, NULL, 0},
    {"label", 0, 0, 0, 0, 0, 0, 1, "form field label text ", NULL, NULL, NULL,
     NULL, NULL, 0},
    {"legend", 0, 0, 0, 0, 0, 0, 0, "fieldset legend ", NULL, NULL, NULL, NULL,
     NULL, 0},
    {"li", 0, 1, 1, 0, 0, 0, 0, "list item ", NULL, NULL, NULL, NULL, NULL, 0},
    {"link", 0, 2, 2, 1, 0, 0, 0, "a media-independent link ", NULL, NULL, NULL,
     NULL, NULL, 0},
    {"map", 0, 0, 0, 0, 0, 0, 2, "client-side image map ", NULL, NULL, NULL,
     NULL, NULL, 0},
    {"menu", 0, 0, 0, 0, 1, 1, 0, "menu list ", NULL, NULL, NULL, NULL, NULL,
     0},
    {"meta", 0, 2, 2, 1, 0, 0, 0, "generic metainformation ", NULL, NULL, NULL,
     NULL, NULL, 0},
    {"noembed", 0, 0, 0, 0, 0, 0, 0, "", NULL, NULL, NULL, NULL, NULL,
     DATA_RAWTEXT},
    {"noframes", 0, 0, 0, 0, 0, 2, 0,
     "alternate content container for non frame-based rendering ", NULL, NULL,
     NULL, NULL, NULL, DATA_RAWTEXT},
    {"noscript", 0, 0, 0, 0, 0, 0, 0,
     "alternate content container for non script-based rendering ", NULL, NULL,
     NULL, NULL, NULL, 0},
    {"object", 0, 0, 0, 0, 0, 0, 2, "generic embedded object ", NULL, NULL,
     NULL, NULL, NULL, 0},
    {"ol", 0, 0, 0, 0, 0, 0, 0, "ordered list ", NULL, NULL, NULL, NULL, NULL,
     0},
    {"optgroup", 0, 0, 0, 0, 0, 0, 0, "option group ", NULL, NULL, NULL, NULL,
     NULL, 0},
    {"option", 0, 1, 0, 0, 0, 0, 0, "selectable choice ", NULL, NULL, NULL,
     NULL, NULL, 0},
    {"p", 0, 1, 0, 0, 0, 0, 0, "paragraph ", NULL, NULL, NULL, NULL, NULL, 0},
    {"param", 0, 2, 2, 1, 0, 0, 0, "named property value ", NULL, NULL, NULL,
     NULL, NULL, 0},
    {"plaintext", 0, 0, 0, 0, 0, 0, 0, "", NULL, NULL, NULL, NULL, NULL,
     DATA_PLAINTEXT},
    {"pre", 0, 0, 0, 0, 0, 0, 0, "preformatted text ", NULL, NULL, NULL, NULL,
     NULL, 0},
    {"q", 0, 0, 0, 0, 0, 0, 1, "short inline quotation ", NULL, NULL, NULL,
     NULL, NULL, 0},
    {"s", 0, 3, 0, 0, 1, 1, 1, "strike-through text style", NULL, NULL, NULL,
     NULL, NULL, 0},
    {"samp", 0, 0, 0, 0, 0, 0, 1, "sample program output, scripts, etc.", NULL,
     NULL, NULL, NULL, NULL, 0},
    {"script", 0, 0, 0, 0, 0, 0, 2, "script statements ", NULL, NULL, NULL,
     NULL, NULL, DATA_SCRIPT},
    {"select", 0, 0, 0, 0, 0, 0, 1, "option selector ", NULL, NULL, NULL, NULL,
     NULL, 0},
    {"small", 0, 3, 0, 0, 0, 0, 1, "small text style", NULL, NULL, NULL, NULL,
     NULL, 0},
    {"source", 0, 0, 2, 1, 0, 0, 0, "", NULL, NULL, NULL, NULL, NULL, 0},
    {"span", 0, 0, 0, 0, 0, 0, 1, "generic language/style container ", NULL,
     NULL, NULL, NULL, NULL, 0},
    {"strike", 0, 3, 0, 0, 1, 1, 1, "strike-through text", NULL, NULL, NULL,
     NULL, NULL, 0},
    {"strong", 0, 3, 0, 0, 0, 0, 1, "strong emphasis", NULL, NULL, NULL, NULL,
     NULL, 0},
    {"style", 0, 0, 0, 0, 0, 0, 0, "style info ", NULL, NULL, NULL, NULL, NULL,
     DATA_RAWTEXT},
    {"sub", 0, 3, 0, 0, 0, 0, 1, "subscript", NULL, NULL, NULL, NULL, NULL, 0},
    {"sup", 0, 3, 0, 0, 0, 0, 1, "superscript ", NULL, NULL, NULL, NULL, NULL,
     0},
    {"table", 0, 0, 0, 0, 0, 0, 0, "", NULL, NULL, NULL, NULL, NULL, 0},
    {"tbody", 1, 0, 0, 0, 0, 0, 0, "table body ", NULL, NULL, NULL, NULL, NULL,
     0},
    {"td", 0, 0, 0, 0, 0, 0, 0, "table data cell", NULL, NULL, NULL, NULL, NULL,
     0},
    {"textarea", 0, 0, 0, 0, 0, 0, 1, "multi-line text field ", NULL, NULL,
     NULL, NULL, NULL, DATA_RCDATA},
    {"tfoot", 0, 1, 0, 0, 0, 0, 0, "table footer ", NULL, NULL, NULL, NULL,
     NULL, 0},
    {"th", 0, 1, 0, 0, 0, 0, 0, "table header cell", NULL, NULL, NULL, NULL,
     NULL, 0},
    {"thead", 0, 1, 0, 0, 0, 0, 0, "table header ", NULL, NULL, NULL, NULL,
     NULL, 0},
    {"title", 0, 0, 0, 0, 0, 0, 0, "document title ", NULL, NULL, NULL, NULL,
     NULL, DATA_RCDATA},
    {"tr", 0, 0, 0, 0, 0, 0, 0, "table row ", NULL, NULL, NULL, NULL, NULL, 0},
    {"track", 0, 0, 2, 1, 0, 0, 0, "", NULL, NULL, NULL, NULL, NULL, 0},
    {"tt", 0, 3, 0, 0, 0, 0, 1, "teletype or monospaced text style", NULL, NULL,
     NULL, NULL, NULL, 0},
    {"u", 0, 3, 0, 0, 1, 1, 1, "underlined text style", NULL, NULL, NULL, NULL,
     NULL, 0},
    {"ul", 0, 0, 0, 0, 0, 0, 0, "unordered list ", NULL, NULL, NULL, NULL, NULL,
     0},
    {"var", 0, 0, 0, 0, 0, 0, 1, "instance of a variable or program argument",
     NULL, NULL, NULL, NULL, NULL, 0},
    {"wbr", 0, 0, 2, 1, 0, 0, 0, "", NULL, NULL, NULL, NULL, NULL, 0},
    {"xmp", 0, 0, 0, 0, 0, 0, 1, "", NULL, NULL, NULL, NULL, NULL,
     DATA_RAWTEXT}};
 ...
 */
static const htmlStartCloseEntry htmlStartClose[] = {{"a", "a"},
                                                     {"a", "fieldset"},
                                                     {"a", "table"},
                                                     {"a", "td"},
                                                     {"a", "th"},
 ...
 */
int htmlUTF8ToHtml(unsigned char *out, int *outlen, const unsigned char *in,
                   int *inlen) {
...
static const xmlChar *htmlFindEntityPrefix(const xmlChar *string, size_t slen,
                                           int isAttr, int *nlen, int *rlen) {
  ...
  while (left < right) {
    ...
    if (cmp == 0) {
      if (slen < len) {
        cmp = strncmp((const char *)string + soff + 1, (const char *)bytes + 2,
                      slen - 1);
...
static xmlChar *htmlParseData(htmlParserCtxtPtr ctxt, htmlAsciiMask mask,
    ...
    while (!PARSER_STOPPED(ctxt)) {
      ...
      case '&':
        ...
        if ((j < avail) && (in[j] == '#')) {
          ...
          repl = htmlFindEntityPrefix(in + j, avail - j,
                                      /* isAttr */ 1, &skip, &replSize);
          if (repl != NULL) {
            skip += 1;
            goto next_chunk;
          }
 ...
 * @returns NULL.
 */
const htmlEntityDesc *htmlParseEntityRef(htmlParserCtxt *ctxt ATTRIBUTE_UNUSED,
...
static xmlChar *htmlParseAttValue(htmlParserCtxtPtr ctxt) {
  xmlChar *ret = NULL;
  int maxLength = (ctxt->options & HTML_PARSE_HUGE) ? XML_MAX_HUGE_LENGTH
                                                    : XML_MAX_TEXT_LENGTH;
...
static void htmlCharDataSAXCallback(htmlParserCtxtPtr ctxt, const xmlChar *buf,
                                    int size, int mode) {
...
static int htmlParseCharData(htmlParserCtxtPtr ctxt, int partial) {
  ...
  while (!PARSER_STOPPED(ctxt)) {
    ...
    while (!PARSER_STOPPED(ctxt)) {
      ...
      if (!ncr) {
        while (avail > 0) {
          static const unsigned mask[8] = {0x00002401, 0x10002040, 0x00000000,
 ...
 * @returns 0
 */
int htmlParseCharRef(htmlParserCtxt *ctxt ATTRIBUTE_UNUSED) { return (0); }
...
static xmlChar *htmlParseDoctypeLiteral(htmlParserCtxtPtr ctxt) {
  xmlChar *ret;
  int maxLength = (ctxt->options & HTML_PARSE_HUGE) ? XML_MAX_TEXT_LENGTH
                                                    : XML_MAX_NAME_LENGTH;
...
static void htmlParseDocTypeDecl(htmlParserCtxtPtr ctxt) {
   ...
   */
  if ((UPPER == 'P') && (UPP(1) == 'U') && (UPP(2) == 'B') && (UPP(3) == 'L') &&
      (UPP(4) == 'I') && (UPP(5) == 'C')) {
    SKIP(6);
    SKIP_BLANKS;
  ...
  } else if ((UPPER == 'S') && (UPP(1) == 'Y') && (UPP(2) == 'S') &&
             (UPP(3) == 'T') && (UPP(4) == 'E') && (UPP(5) == 'M')) {
    SKIP(6);
    SKIP_BLANKS;
    URI = htmlParseDoctypeLiteral(ctxt);
  }
...
static xmlHashedString htmlParseAttribute(htmlParserCtxtPtr ctxt,
                                          xmlChar **value) {
...
static int htmlCharEncCheckAsciiCompatible(htmlParserCtxt *ctxt,
  ...
  if ((res != XML_ENC_ERR_SUCCESS) || (inlen != 8) || (outlen != 8) ||
      (memcmp(in, out, 8) != 0)) {
 ...
 */
static int htmlAttrHashInsert(xmlParserCtxtPtr ctxt, unsigned size,
                              const xmlChar *name, unsigned hashValue,
                              int aindex) {
...
static void htmlParseStartTag(htmlParserCtxtPtr ctxt) {
   ...
   */
  SKIP_BLANKS;
  while ((ctxt->input->cur < ctxt->input->end) && (CUR != '>') &&
         ((CUR != '/') || (NXT(1) != '>')) && (PARSER_STOPPED(ctxt) == 0)) {
    ...
    if (attname != NULL) {
      ...
      if (nbatts + 4 > maxatts) {
        ...
        newSize = xmlGrowCapacity(maxatts, sizeof(tmp[0]) * 2 + sizeof(utmp[0]),
                                  11, HTML_MAX_ATTRS);
        if (newSize < 0) {
          htmlErrMemory(ctxt);
          goto failed;
  ...
  while ((PARSER_STOPPED(ctxt) == 0) && (ctxt->input->cur < ctxt->input->end)) {
    ...
    if ((mode == 0) && (CUR == '<')) {
      if (NXT(1) == '/') {
         ...
         */
        if ((UPP(2) == 'D') && (UPP(3) == 'O') && (UPP(4) == 'C') &&
            (UPP(5) == 'T') && (UPP(6) == 'Y') && (UPP(7) == 'P') &&
            (UPP(8) == 'E')) {
 ...
 * @returns a node list.
 */
xmlNode *htmlCtxtParseContentInternal(htmlParserCtxt *ctxt,
  ...
  while (CUR == '<') {
    if (NXT(1) == '!') {
      if ((NXT(2) == '-') && (NXT(3) == '-')) {
        SKIP(4);
        htmlParseComment(ctxt, /* bogus */ 0);
      } else if ((UPP(2) == 'D') && (UPP(3) == 'O') && (UPP(4) == 'C') &&
                 (UPP(5) == 'T') && (UPP(6) == 'Y') && (UPP(7) == 'P') &&
                 (UPP(8) == 'E')) {
        htmlParseDocTypeDecl(ctxt);
 ...
 * @param ctxt  an HTML parser context
 */
void htmlFreeParserCtxt(htmlParserCtxt *ctxt) { xmlFreeParserCtxt(ctxt); }
...
htmlCreateMemoryParserCtxtInternal(const char *url, const char *buffer,
 ...
 */
static htmlParserCtxtPtr htmlCreateDocParserCtxt(const xmlChar *str,
                                                 const char *url,
                                                 const char *encoding) {
  xmlParserCtxtPtr ctxt;
  xmlParserInputPtr input;
...
static int htmlParseLookupGt(xmlParserCtxtPtr ctxt) {
  ...
  while (cur < end) {
    ...
    if (state != LSTATE_ATTR_VALUE_SQUOTED &&
      ...
      if (c == '/' && state != LSTATE_BEFORE_ATTR_VALUE &&
 ...
 */
static int htmlParseLookupString(xmlParserCtxtPtr ctxt, size_t startDelta,
 ...
 */
int htmlParseChunk(htmlParserCtxt *ctxt, const char *chunk, int size,
                   int terminate) {
  if ((ctxt == NULL) || (ctxt->input == NULL) || (ctxt->input->buf == NULL) ||
      (size < 0) || ((size > 0) && (chunk == NULL)))
 ...
 * @param encoding  a free form C string describing the HTML document encoding,
 * or NULL
 ...
 * @returns 1
 */
int htmlElementAllowedHere(const htmlElemDesc *parent ATTRIBUTE_UNUSED,
 ...
 * @returns HTML_VALID
 */
htmlStatus htmlElementStatusHere(const htmlElemDesc *parent ATTRIBUTE_UNUSED,
 ...
 * @returns HTML_VALID
 */
htmlStatus htmlAttrAllowed(const htmlElemDesc *elt ATTRIBUTE_UNUSED,
 ...
 * @returns HTML_VALID
 */
htmlStatus htmlNodeStatus(xmlNode *node ATTRIBUTE_UNUSED,
                          int legacy ATTRIBUTE_UNUSED) {
  return (HTML_VALID);
}
 ...
 * @param ctxt  an HTML parser context
 */
void htmlCtxtReset(htmlParserCtxt *ctxt) { xmlCtxtReset(ctxt); }

static int htmlCtxtSetOptionsInternal(xmlParserCtxtPtr ctxt, int options,
                                      int keepMask) {
  int allMask;
  ...
  allMask = HTML_PARSE_RECOVER | HTML_PARSE_HTML5 | HTML_PARSE_NODEFDTD |
            HTML_PARSE_NOERROR | HTML_PARSE_NOWARNING | HTML_PARSE_PEDANTIC |
            HTML_PARSE_NOBLANKS | HTML_PARSE_NONET | HTML_PARSE_NOIMPLIED |
            HTML_PARSE_COMPACT | HTML_PARSE_HUGE | HTML_PARSE_IGNORE_ENC |
...
int htmlCtxtUseOptions(htmlParserCtxt *ctxt, int options) {
   ...
   */
  keepMask = HTML_PARSE_NODEFDTD | HTML_PARSE_NOERROR | HTML_PARSE_NOWARNING |
 ...
 * @returns the resulting document tree.
 */
xmlDoc *htmlReadDoc(const xmlChar *str, const char *url, const char *encoding,
                    int options) {
  htmlParserCtxtPtr ctxt;
  xmlParserInputPtr input;
  htmlDocPtr doc = NULL;
 ...
 * @returns the resulting document tree
 */
xmlDoc *htmlCtxtReadFd(xmlParserCtxt *ctxt, int fd, const char *URL,
                       const char *encoding, int options) {
  xmlParserInputPtr input;
