 ...
 */
static xmlEntityPtr xmlCreateEntity(xmlDocPtr doc, const xmlChar *name,
 ...
 * @returns a pointer to the entity or NULL in case of error
 */
xmlEntity *xmlNewEntity(xmlDoc *doc, const xmlChar *name, int type,
                        const xmlChar *publicId, const xmlChar *systemId,
                        const xmlChar *content) {
 ...
 * @returns a newly allocated string with substitutions.
 */
xmlChar *xmlEncodeSpecialChars(const xmlDoc *doc ATTRIBUTE_UNUSED,
                               const xmlChar *input) {
  if (input == NULL)
    return (NULL);
 ...
 * @param name  its name
 */
static void xmlFreeEntityWrapper(void *entity,
 ...
 */
static void *xmlCopyEntity(void *payload,
                           const xmlChar *name ATTRIBUTE_UNUSED) {
 ...
 * @param name  unused
 */
static void xmlDumpEntityDeclScan(void *ent, void *save,
                                  const xmlChar *name ATTRIBUTE_UNUSED) {
