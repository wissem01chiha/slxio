...
def get_libuv_version():
    ...
    try:
        ...
        return "%d.%d.%d%s" % (
            ...
            minor,
            patch,
            "-%s" % suffix if not is_release else "",
        )
    except Exception:
        return "unknown"
...
project = "libuv API documentation"
...
latex_documents = [
    ("index", "libuv.tex", "libuv documentation", "libuv contributors", "manual"),
]
...
man_pages = [("index", "libuv", "libuv documentation", ["libuv contributors"], 1)]
...
epub_title = "libuv documentation"
epub_author = "libuv contributors"
epub_publisher = "libuv contributors"
epub_copyright = "2014-present, libuv contributors"
