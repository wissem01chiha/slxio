...
#define E_PATH_NOT_FOUND SLXIO_HERROR(SLXIO_PROJECT, COMMON, CORE, SLXIO_FATAL, 3U)
#define E_PATH_TOO_LONG SLXIO_HERROR(SLXIO_PROJECT, COMMON, CORE, SLXIO_FATAL, 4U)
