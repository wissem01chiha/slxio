...
public:
    ...
    define their custom type and return it via this function, if there they
    intend to override the default type  */
    DataType GetDataType() const
    {
        return DataType::SLXIO_TYPE_GENERIC_LOGGER;
    };

    /* Append ILogMessage Based Object in a stream way to the ILogger based
     * object
     */
