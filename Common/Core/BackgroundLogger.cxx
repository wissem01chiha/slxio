...
BackgroundLogger::BackgroundLogger() : m_nthreads(1), m_queueSize(8192) {}
...
void BackgroundLogger::SetLogLevel(LogLevelType level) { m_level = level; }

LogLevelType BackgroundLogger::GetLogLevel() const { return m_level; }

void BackgroundLogger::SetQueueSize(UInt32 q) { m_queueSize = q; }

UInt32 BackgroundLogger::GetQueueSize() { return m_queueSize; }

BackgroundLogger::~BackgroundLogger() { spdlog::shutdown(); }
