...
static void TermCompletionOnFiles(char** dictionaryFiles,
                                  ...
                                  unsigned int* cursor,
                                  unsigned int* cursor_max);
static int CopyLineAtPrompt(char** wk_buf,
                            char* line,
                            unsigned int* cursor,
                            unsigned int* cursor_max);
static void separateFilesDirectories(char** dictionary,
                                     int size,
                                     char*** files,
                                     int* sizeFiles,
                                     char*** directories,
...
static void TermCompletionOnAll(char* lineBeforeCaret,
                                char* lineAfterCaret,
                                char* defaultPattern,
                                char** wk_buf,
                                unsigned int* cursor,
...
static void displayCompletionDictionary(char** dictionary,
                                        int sizedictionary,
                                        char* namedictionary);

static char** concatenateStrings(int* sizearrayofstring,
                                 char* string1,
                                 char* string2,
                                 char* string3,
                                 char* string4,
                         ...
                         unsigned int* cursor_max)
{
  ...
  if (completionDictionaryFiles) {
    ...
    TermCompletionOnAll(LineBeforeCaret,
                        LineAfterCaret,
                        SearchedPattern,
                        wk_buf,
                        cursor,
                                  ...
                                  unsigned int* cursor_max)
{
  if (dictionaryFiles) {
    if (sizedictionaryFiles == 1) {
      char* new_line = completeLine(lineBeforeCaret,
                                    dictionaryFiles[0],
                                    filePattern,
                                    defaultPattern,
                                    TRUE,
      ...
      char** directories;
      int sizeDirectories;
      separateFilesDirectories(dictionaryFiles,
                               sizedictionaryFiles,
                               &files,
                               &sizeFiles,
                               &directories,
                                ...
                                unsigned int* cursor_max)
{
  if (defaultPattern) {
    ...
    numberWordFound =
      sizecompletionDictionaryFunctions + sizecompletionDictionaryCommandWords +
    ...
    if (numberWordFound > 0) {
      if (numberWordFound == 1) {
        ...
        new_line = completeLine(lineBeforeCaret,
                                completionDictionary[0],
                                NULL,
                                defaultPattern,
                                FALSE,
                                lineAfterCaret);
        ...
        if (completionDictionaryFields) {
          ...
          char** commonsDictionary =
            concatenateStrings(&sizecommonsDictionary,
                               commonFunctions,
                               commonMacros,
                               commonCommandWords,
                               commonVariables,
